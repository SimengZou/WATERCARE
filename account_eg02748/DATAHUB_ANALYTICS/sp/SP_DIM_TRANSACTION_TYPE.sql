CREATE OR REPLACE PROCEDURE "SP_DIM_TRANSACTION_TYPE"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_TRANSACTION_TYPE target USING (SELECT  ";
			...
			sql_command += "   FROM DATAHUB_STAGING.STG_DIM_TRANSACTION_TYPE";
			sql_command += "   ) AS b ON target.TRANSACTION_TYPE_code =b.TRANSACTION_TYPE_code";
			sql_command += "    AND target.TRANSACTION_DESIGNATOR_code =b.TRANSACTION_DESIGNATOR_code";
