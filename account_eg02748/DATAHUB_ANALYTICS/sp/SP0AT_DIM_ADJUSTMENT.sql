CREATE OR REPLACE PROCEDURE "SP0AT_DIM_ADJUSTMENT"()
...
//  Run merge statement
			...
			sql_command += "  ACCTTRAN.ADJUSTMENT_KEY,";
			sql_command += "  ''Not Available'' AS ADJUSTMENT_REASON_DESCRIPTION,";
			sql_command += "  ''Not Available'' AS ADJUSTMENT_TYPE_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_ADJUSTMENT ADJUSTMENT ON ACCTTRAN.ADJUSTMENT_KEY =ADJUSTMENT.ADJUSTMENT_KEY";
			sql_command += "    WHERE ADJUSTMENT.ADJUSTMENT_KEY IS NULL AND ACCTTRAN.ADJUSTMENT_KEY IS NOT NULL";
