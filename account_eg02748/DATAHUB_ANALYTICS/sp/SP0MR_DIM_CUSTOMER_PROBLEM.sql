CREATE OR REPLACE PROCEDURE "SP0MR_DIM_CUSTOMER_PROBLEM"()
...
//  Run merge statement
			...
			sql_command += "  READING.CUSTOMER_PROBLEM_NUMBER,";
			sql_command += "  ''Not Available'' AS CUSTOMER_PROBLEM_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_CUSTOMER_PROBLEM CUSTPROBLEM ON READING.CUSTOMER_PROBLEM_NUMBER= CUSTPROBLEM.CUSTOMER_PROBLEM_NUMBER";
			sql_command += " WHERE CUSTPROBLEM.CUSTOMER_PROBLEM_NUMBER IS NULL AND READING.CUSTOMER_PROBLEM_NUMBER IS NOT NULL";
			sql_command += " GROUP BY 1";
			sql_command += "  ) AS b ON target.CUSTOMER_PROBLEM_NUMBER = b.CUSTOMER_PROBLEM_NUMBER";
			sql_command += "  WHEN NOT MATCHED THEN INSERT (CUSTOMER_PROBLEM_NUMBER, ";
			...
			sql_command += "  VALUES (b.CUSTOMER_PROBLEM_NUMBER, ";
