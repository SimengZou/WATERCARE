CREATE OR REPLACE PROCEDURE "SP_DIM_READ_SOURCE"()
...
//  Run merge statement
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_READ_SOURCE";
		sql_command += " ) AS b ON target.READ_SOURCE_CODE =b.READ_SOURCE_CODE";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += "  SET target.READ_SOURCE_DESCRIPTION = b.READ_SOURCE_DESCRIPTION,";
