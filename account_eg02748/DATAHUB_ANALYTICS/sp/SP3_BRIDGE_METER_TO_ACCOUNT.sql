CREATE OR REPLACE PROCEDURE "SP3_BRIDGE_METER_TO_ACCOUNT"()
...
//  Run merge statement
		...
		var sql_command = " UPDATE DATAHUB_ANALYTICS.BRIDGE_METER_TO_ACCOUNT b";
			...
			sql_command += " b.account_sid<>0 AND b.current_record=''Y''";
			sql_command += " AND b.account_sid IN (SELECT DISTINCT ACCOUNT_SID FROM DATAHUB_ANALYTICS.BRIDGE_METER_TO_ACCOUNT ";
