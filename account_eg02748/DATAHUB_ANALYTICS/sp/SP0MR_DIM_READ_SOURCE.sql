CREATE OR REPLACE PROCEDURE "SP0MR_DIM_READ_SOURCE"()
...
//  Run merge statement
	        ...
	        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_READ_SOURCE target USING (SELECT  ";
			sql_command += "  READING.READ_SOURCE AS READ_SOURCE_CODE,";
			sql_command += "  ''Not Available'' AS READ_SOURCE_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_READ_SOURCE READSOURCE ON upper(READING.READ_SOURCE)= upper(READSOURCE.READ_SOURCE_CODE)";
			sql_command += " WHERE READSOURCE.READ_SOURCE_CODE IS NULL AND READING.READ_SOURCE IS NOT NULL";
			sql_command += " GROUP BY 1";
			sql_command += "  ) AS b ON upper(target.READ_SOURCE_CODE) = upper(b.READ_SOURCE_CODE)";
			sql_command += "  WHEN NOT MATCHED THEN INSERT (READ_SOURCE_CODE, ";
			...
			sql_command += "  VALUES (b.READ_SOURCE_CODE, ";
			sql_command += "  b.READ_SOURCE_DESCRIPTION ,";
