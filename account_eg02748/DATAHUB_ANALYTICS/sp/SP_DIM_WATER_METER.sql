CREATE OR REPLACE PROCEDURE "SP_DIM_WATER_METER"()
...
//  Get the last date that was extracted 
//    get_datetime_sql_command = "select to_char(DATEADD(''HOUR'',-1,INC_LOAD_DATETIME),''YYYY-MM-DD HH:MM:SS'') from datahub_logging.etl_control_job ";
//    get_datetime_sql_command += "where process_name = ''" + process_name + "'';";
//    var date_status_result = snowflake.execute({sqlText: get_datetime_sql_command}); 
//    var inc_load_datetime =""; 
//	if (date_status_result.getRowCount() > 0) 
//        {
//        date_status_result.next();                                                                               // expecting a maximum of 1 row
//        inc_load_datetime = date_status_result.getColumnValue(1);                                          // and only 1 return value
//        } 
//	
//    if( debug === "True" ) 
//            {
//            debug_statement = "call datahub_logging.sp_etl_log_process_debug(''" + process_name + "'',''Date for incremental extract: " + inc_load_datetime + "'');";
//            snowflake.execute({sqlText: debug_statement}); 
//            }
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_WATER_METER target USING (SELECT  ";
		...
		sql_command += " FROM DATAHUB_STAGING.STG2_DIM_WATER_METER";
		sql_command += "  ) AS b ON target.COMP_KEY =b.comp_key";
		sql_command += "  WHEN MATCHED THEN UPDATE SET target.ADDRESS_KEY = b.ADDRESS_KEY,";
		sql_command += "    target.ROUTE_SID = b.ROUTE_SID,";
		sql_command += "    target.ROUTE_KEY = b.ROUTE_KEY,";
		sql_command += "    target.COMP_KEY = b.COMP_KEY,";
		sql_command += "    target.METER_POSITION = b.METER_POSITION,";
		sql_command += "    target.ADDRESS_QUALIIFIER = b.ADDRESS_QUALIIFIER,";
		sql_command += "    target.AREA = b.AREA,";
		sql_command += "    target.AVERAGE_MONTHLY_USAGE = b.AVERAGE_MONTHLY_USAGE,";
		sql_command += "    target.SERVICE_STATUS = b.SERVICE_STATUS,";
		sql_command += "    target.UNIT_TYPE = b.UNIT_TYPE,";
		sql_command += "    target.METER_ADDED_DATE = b.METER_ADDED_DATE,";
		sql_command += "    target.METER_MODIFIED_DATE = b.METER_MODIFIED_DATE,";
		sql_command += "    target.METER_INSTALLED_DATE = b.METER_INSTALLED_DATE,";
		sql_command += "    target.METER_SIZE = b.METER_SIZE,";
		sql_command += "    target.SIZE_UNIT_OF_MEASURE = b.SIZE_UNIT_OF_MEASURE,";
		sql_command += "    target.MANUFACTURER_KEY = b.MANUFACTURER_KEY,";
		sql_command += "    target.METER_MODEL_NUMBER = b.METER_MODEL_NUMBER,";
		sql_command += "    target.METER_SERIAL_NUMBER = b.METER_SERIAL_NUMBER,";
		sql_command += "    target.METER_SERVICE_TYPE = b.METER_SERVICE_TYPE,";
		sql_command += "    target.METER_ID = b.METER_ID,";
		sql_command += "    target.METER_DESCRIPTION = b.METER_DESCRIPTION,";
		sql_command += "    target.METER_MANUFACTURER_CODE = b.METER_MANUFACTURER_CODE,";
		sql_command += "    target.METER_OWNERSHIP = b.METER_OWNERSHIP,";
		sql_command += "    target.ETL_LOAD_DATETIME = b.ETL_LOAD_DATETIME,";
		sql_command += "    target.ETL_RECORD_UPDATED =current_timestamp()";
		sql_command += "  WHEN NOT MATCHED THEN INSERT (ADDRESS_KEY, ";
		sql_command += "  ROUTE_SID, ";
		sql_command += "  ROUTE_KEY, ";
		sql_command += "  COMP_KEY, ";
		sql_command += "  METER_POSITION,";
		...
		sql_command += "  ETL_RECORD_CREATED,";
		sql_command += "  ETL_RECORD_UPDATED) ";
		sql_command += "  VALUES (b.ADDRESS_KEY,";
		sql_command += "  b.ROUTE_SID,";
		sql_command += "  b.ROUTE_KEY,";
		sql_command += "  b.COMP_KEY,";
		sql_command += "  b.METER_POSITION,";
		sql_command += "  b.ADDRESS_QUALIIFIER,";
		sql_command += "  b.AREA,";
		sql_command += "  b.AVERAGE_MONTHLY_USAGE,";
		sql_command += "  b.SERVICE_STATUS,";
		sql_command += "  b.UNIT_TYPE,";
		sql_command += "  b.METER_ADDED_DATE,";
		sql_command += "  b.METER_MODIFIED_DATE,";
		sql_command += "  b.METER_INSTALLED_DATE,";
		sql_command += "  b.METER_SIZE,";
		sql_command += "  b.SIZE_UNIT_OF_MEASURE,";
		sql_command += "  b.MANUFACTURER_KEY,";
		sql_command += "  b.METER_MODEL_NUMBER,";
		sql_command += "  b.METER_SERIAL_NUMBER,";
		sql_command += "  b.METER_SERVICE_TYPE,";
		sql_command += "  b.METER_ID,";
		sql_command += "  b.METER_DESCRIPTION,";
		sql_command += "  b.METER_MANUFACTURER_CODE,";
		sql_command += "  b.METER_OWNERSHIP,";
		sql_command += "  b.ETL_LOAD_DATETIME,";
