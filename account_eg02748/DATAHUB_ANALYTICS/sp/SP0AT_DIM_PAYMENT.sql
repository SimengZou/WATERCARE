CREATE OR REPLACE PROCEDURE "SP0AT_DIM_PAYMENT"()
...
//  Run merge statement
			...
			sql_command += "  ACCTTRAN.PAY_KEY,";
			sql_command += "  ''Not Available'' AS PAYMENT_COMMENTS,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_PAYMENT PAYMENT ON ACCTTRAN.PAY_KEY =PAYMENT.PAY_KEY";
			sql_command += "    WHERE PAYMENT.PAY_KEY IS NULL AND ACCTTRAN.PAY_KEY IS NOT NULL";
