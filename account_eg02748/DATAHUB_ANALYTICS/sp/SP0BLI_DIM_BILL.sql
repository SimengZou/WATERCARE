CREATE OR REPLACE PROCEDURE "SP0BLI_DIM_BILL"()
...
//  Run merge statement
			...
			sql_command += "  BILLLINEITEM.BILL_KEY,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_BILL BILL ON BILLLINEITEM.BILL_KEY =BILL.BILL_KEY";
			sql_command += "    WHERE BILL.BILL_KEY IS NULL AND BILLLINEITEM.BILL_KEY IS NOT NULL";
