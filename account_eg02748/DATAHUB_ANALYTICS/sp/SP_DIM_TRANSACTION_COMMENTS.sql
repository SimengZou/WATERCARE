CREATE OR REPLACE PROCEDURE "SP_DIM_TRANSACTION_COMMENTS"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_TRANSACTION_COMMENTS target USING (SELECT  ";
			...
			sql_command += "  FROM DATAHUB_STAGING.STG_DIM_TRANSACTION_COMMENTS";
			sql_command += "  ) AS b ON target.TRANSACTION_COMMENTS_key =b.TRANSACTION_COMMENTS_key";
			sql_command += "  WHEN MATCHED THEN UPDATE ";
			sql_command += "  SET target.TRANSACTION_COMMENTS =b.TRANSACTION_COMMENTS ,";
