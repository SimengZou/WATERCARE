CREATE OR REPLACE PROCEDURE "SP0BLI_DIM_BILL_LINE_ITEM_SETUP"()
...
//  Run merge statement
			...
			sql_command += "  BILLLINEITEM.BILL_LINE_ITEM_SETUP_KEY,";
			sql_command += "  ''Not Available'' AS BILL_LINE_ITEM_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_BILL_LINE_ITEM_SETUP LINEITEMSETUP ON BILLLINEITEM.BILL_LINE_ITEM_SETUP_KEY =LINEITEMSETUP.BILL_LINE_ITEM_SETUP_KEY";
			sql_command += "    WHERE LINEITEMSETUP.BILL_LINE_ITEM_SETUP_KEY IS NULL AND BILLLINEITEM.BILL_LINE_ITEM_SETUP_KEY IS NOT NULL";
			sql_command += " GROUP BY 1";
			sql_command += "  ) AS b ON target.BILL_LINE_ITEM_SETUP_key =b.BILL_LINE_ITEM_SETUP_key";
			sql_command += "  WHEN NOT MATCHED THEN INSERT (BILL_LINE_ITEM_SETUP_KEY, ";
			...
			sql_command += "  VALUES (b.BILL_LINE_ITEM_SETUP_KEY, ";
