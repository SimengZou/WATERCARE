CREATE OR REPLACE PROCEDURE "SP_DIM_EMPLOYEE"()
...
//  Run merge statement
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_EMPLOYEE";
		sql_command += " ) AS b ON target.EMPLOYEE_CODE =b.EMPLOYEE_CODE";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += "  SET target.EMPLOYEE_CONTACT_KEY = b.EMPLOYEE_CONTACT_KEY,";
		sql_command += " target.EMPLOYEE_NAME=b.EMPLOYEE_NAME , ";
		...
		sql_command += " b.EMPLOYEE_CONTACT_KEY, ";
