CREATE OR REPLACE PROCEDURE "SP0BH_DIM_BILL_RUN"()
...
//  Run merge statement
			...
			sql_command += "  ''Not Available'' AS BILL_RUN_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_BILL_RUN BILLRUN ON BILLHEADER.BILL_RUN_KEY =BILLRUN.BILL_RUN_KEY";
			sql_command += "    WHERE BILLRUN.BILL_RUN_KEY IS NULL AND BILLHEADER.BILL_RUN_KEY IS NOT NULL";
