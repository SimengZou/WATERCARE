CREATE OR REPLACE PROCEDURE "SP_DIM_READ_REASON"()
...
//  Run merge statement
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_READ_REASON";
		sql_command += " ) AS b ON target.READ_REASON_CODE =b.READ_REASON_CODE";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += "  SET target.READ_REASON_DESCRIPTION = b.READ_REASON_DESCRIPTION,";
