CREATE OR REPLACE PROCEDURE "SP0BLI_DIM_GL_MAPPING_INFORMATION"()
...
//  Run merge statement
			...
			sql_command += "  ''Not Available'' AS GL_MAPPING_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_GL_MAPPING_INFORMATION GLMAPPING ON BILLLINEITEM.LINEITEM_CODE=GLMAPPING.GL_MAPPING_CODE";
			sql_command += "    WHERE GLMAPPING.GL_MAPPING_CODE IS NULL AND BILLLINEITEM.LINEITEM_CODE IS NOT NULL";
			sql_command += " GROUP BY 1";
			sql_command += "  ) AS b ON upper(target.GL_MAPPING_CODE) =upper(b.LINEITEM_CODE)";
			...
			sql_command += "  VALUES (b.LINEITEM_CODE, ";
