CREATE OR REPLACE PROCEDURE "SP0BH_DIM_BILL"()
...
//  Run merge statement
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_BILL BILL ON BILLHEADER.BILL_KEY =BILL.BILL_KEY";
			sql_command += "    WHERE BILL.BILL_KEY IS NULL AND BILLHEADER.BILL_KEY IS NOT NULL";
