CREATE OR REPLACE PROCEDURE "SP_FACT_BILL_HEADER"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.FACT_BILL_HEADER target USING (SELECT  ";
				...
				sql_command += " FROM DATAHUB_STAGING.STG2_FACT_BILL_HEADER";
				...
				sql_command += " target. BILL_RUN_SID =b. BILL_RUN_SID ,";
				sql_command += " target. BILL_DATE_SID =b. BILL_DATE_SID ,";
				sql_command += " target. BILL_ADDED_DATE_SID =b. BILL_ADDED_DATE_SID ,";
				sql_command += " target. BILL_MODIFIED_DATE_SID =b. BILL_MODIFIED_DATE_SID ,";
				...
				sql_command += " target. BILL_RUN_ADDED_DATE_SID =b. BILL_RUN_ADDED_DATE_SID ,";
				sql_command += " target. BILL_FROM_DATE_SID =b. BILL_FROM_DATE_SID ,";
				sql_command += " target. BILL_TO_DATE_SID =b. BILL_TO_DATE_SID ,";
				sql_command += " target. BILL_TYPE_SID =b. BILL_TYPE_SID ,";
				sql_command += " target. BILL_KEY =b. BILL_KEY ,";
				sql_command += " target. BILL_DATE =b. BILL_DATE ,";
				sql_command += " target. BILL_MODIFIED_DATE =b. BILL_MODIFIED_DATE ,";
				sql_command += " target. BILL_ADDED_DATE =b. BILL_ADDED_DATE ,";
				...
				sql_command += " target. PRINCIPAL_TOTAL_AMOUNT =b. PRINCIPAL_TOTAL_AMOUNT ,";
				sql_command += " target. BILL_ACTUAL_AMOUNT =b. BILL_ACTUAL_AMOUNT ,";
				sql_command += " target. BILL_AMOUNT =b. BILL_AMOUNT ,";
				sql_command += " target. PRIOR_BILL_AMOUNT =b. PRIOR_BILL_AMOUNT ,";	
				...
				sql_command += " b. BILL_RUN_SID ,";
				sql_command += " b. BILL_DATE_SID ,";
				sql_command += " b. BILL_ADDED_DATE_SID ,";
				sql_command += " b. BILL_MODIFIED_DATE_SID ,";
				...
				sql_command += " b. BILL_RUN_ADDED_DATE_SID ,";
				sql_command += " b. BILL_FROM_DATE_SID ,";
				sql_command += " b. BILL_TO_DATE_SID ,";
				sql_command += " b. BILL_TYPE_SID ,";
				sql_command += " b. BILL_KEY ,";
				sql_command += " b. BILL_DATE ,";
				sql_command += " b. BILL_MODIFIED_DATE ,";
				sql_command += " b. BILL_ADDED_DATE ,";
				...
				sql_command += " b. PRINCIPAL_TOTAL_AMOUNT ,";
				sql_command += " b. BILL_ACTUAL_AMOUNT ,";
				sql_command += " b. BILL_AMOUNT ,";
				sql_command += " b. PRIOR_BILL_AMOUNT ,";
