CREATE OR REPLACE PROCEDURE "SP_DIM_GL_MAPPING_INFORMATION"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_GL_MAPPING_INFORMATION target USING (SELECT  ";
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_GL_MAPPING_INFORMATION";
		sql_command += " ) AS b ON target.GL_MAPPING_CODE =b.GL_MAPPING_CODE";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += " SET target.GL_MAPPING_DESCRIPTION=b.GL_MAPPING_DESCRIPTION,";
		sql_command += " target.COST_CENTRE_CODE=b.COST_CENTRE_CODE,";
		sql_command += " target.GL_ACCOUNT_CODE=b.GL_ACCOUNT_CODE,";
		sql_command += " target.ETL_SOURCE_DATETIME=b.ETL_SOURCE_DATETIME , ";
		sql_command += " target.ETL_RECORD_UPDATED =current_timestamp()";
		sql_command += " WHEN NOT MATCHED THEN INSERT (GL_MAPPING_CODE, ";
		sql_command += " GL_MAPPING_DESCRIPTION, ";
		sql_command += " COST_CENTRE_CODE, ";
		sql_command += " GL_ACCOUNT_CODE, ";
		sql_command += " ETL_SOURCE_DATETIME, ";
		sql_command += " ETL_RECORD_CREATED, ";
		sql_command += " ETL_RECORD_UPDATED)";
		sql_command += " VALUES (b.GL_MAPPING_CODE, ";
		sql_command += " b.GL_MAPPING_DESCRIPTION,";
		sql_command += " b.COST_CENTRE_CODE,";
		sql_command += " b.GL_ACCOUNT_CODE,";
