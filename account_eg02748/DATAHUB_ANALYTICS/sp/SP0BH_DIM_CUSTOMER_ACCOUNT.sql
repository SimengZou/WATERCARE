CREATE OR REPLACE PROCEDURE "SP0BH_DIM_CUSTOMER_ACCOUNT"()
...
//  Run merge statement
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_CUSTOMER_ACCOUNT ACCOUNT ON BILLHEADER.ACCOUNT_KEY =ACCOUNT.ACCOUNT_KEY";
			sql_command += "    WHERE ACCOUNT.ACCOUNT_KEY IS NULL AND BILLHEADER.ACCOUNT_KEY IS NOT NULL";
