CREATE OR REPLACE PROCEDURE "SP_DIM_ACCOUNT_SERVICE"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_ACCOUNT_SERVICE target USING (SELECT  ";
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_ACCOUNT_SERVICE";
		sql_command += " ) AS b ON target.account_service_key =b.account_service_key";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += " SET target.ACCOUNT_KEY =b.ACCOUNT_KEY ,";
		sql_command += " target.ADDRESS_SERVICE_KEY =b.ADDRESS_SERVICE_KEY ,";
		sql_command += " target.CONSUMPTION_PERCENTRAGE =b.CONSUMPTION_PERCENTRAGE ,";
		sql_command += " target.TARIFF_TYPE =b.TARIFF_TYPE ,";
		sql_command += " target.SERVICE_OPTIONS_KEY =b.SERVICE_OPTIONS_KEY ,";
		sql_command += " target.SERVICE_START_DATE =b.SERVICE_START_DATE ,";
		sql_command += " target.ACCOUNT_SERVICE_STATUS =b.ACCOUNT_SERVICE_STATUS ,";
		sql_command += " target.SERVICE_STOP_DATE =b.SERVICE_STOP_DATE ,";
		sql_command += " target.SERVICE_DESCRIPTION =b.SERVICE_DESCRIPTION ,";
		sql_command += " target.SERVICE_TYPE =b.SERVICE_TYPE ,";
		sql_command += " target.SERVICE_AREA =b.SERVICE_AREA ,";
		sql_command += " target.ETL_SOURCE_DATETIME=b.ETL_SOURCE_DATETIME , ";
		sql_command += " target.ETL_RECORD_UPDATED =current_timestamp(),";
		sql_command += " target.ETL_RECORD_DELETED =b.ETL_RECORD_DELETED,";
		sql_command += " target.CURRENT_RECORD =b.CURRENT_RECORD";
		sql_command += " WHEN NOT MATCHED THEN INSERT (ACCOUNT_SERVICE_KEY, ";
		sql_command += " ACCOUNT_KEY, ";
		sql_command += " ADDRESS_SERVICE_KEY, ";
		sql_command += " CONSUMPTION_PERCENTRAGE, ";
		sql_command += " TARIFF_TYPE, ";
		...
		sql_command += " ETL_RECORD_DELETED, ";
		sql_command += " CURRENT_RECORD)";
		sql_command += " VALUES (b.ACCOUNT_SERVICE_KEY, ";
		sql_command += " b.ACCOUNT_KEY ,";
		sql_command += " b.ADDRESS_SERVICE_KEY ,";
		sql_command += " b.CONSUMPTION_PERCENTRAGE ,";
		sql_command += " b.TARIFF_TYPE ,";
		sql_command += " b.SERVICE_OPTIONS_KEY ,";
		sql_command += " b.SERVICE_START_DATE ,";
		sql_command += " b.ACCOUNT_SERVICE_STATUS ,";
		sql_command += " b.SERVICE_STOP_DATE ,";
		sql_command += " b.SERVICE_DESCRIPTION ,";
		sql_command += " b.SERVICE_TYPE ,";
		sql_command += " b.SERVICE_AREA ,";
		sql_command += " b.ETL_SOURCE_DATETIME, ";
		sql_command += " b.ETL_RECORD_CREATED, ";
		sql_command += " b.ETL_RECORD_UPDATED, ";
		sql_command += " b.ETL_RECORD_DELETED, ";
		sql_command += " b.CURRENT_RECORD);";
