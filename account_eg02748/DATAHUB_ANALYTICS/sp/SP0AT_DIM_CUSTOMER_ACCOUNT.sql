CREATE OR REPLACE PROCEDURE "SP0AT_DIM_CUSTOMER_ACCOUNT"()
...
//  Run merge statement
			...
			sql_command += "  ACCTTRAN.ACCOUNT_KEY,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_CUSTOMER_ACCOUNT ACCOUNT ON ACCTTRAN.ACCOUNT_KEY=ACCOUNT.ACCOUNT_KEY";
			sql_command += "    WHERE ACCOUNT.ACCOUNT_KEY IS NULL AND ACCTTRAN.ACCOUNT_KEY IS NOT NULL";
