CREATE OR REPLACE PROCEDURE "SP_DIM_BILL"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_BILL target USING (SELECT  ";
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_BILL";
		sql_command += " ) AS b ON target.BILL_key =b.BILL_key";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += " SET target.BILL_NUMBER =b.BILL_NUMBER ,";
		sql_command += " target.BILL_ESTIMATE_FLAG =b.BILL_ESTIMATE_FLAG ,";
		sql_command += " target.BILL_PAID_STATUS =b.BILL_PAID_STATUS ,";
		sql_command += " target.BILL_TYPE =b.BILL_TYPE ,";
		sql_command += " target.BILL_DESCRIPTION =b.BILL_DESCRIPTION ,";
		sql_command += " target.ADDRESS_LINE1 =b.ADDRESS_LINE1 ,";
		sql_command += " target.ADDRESS_LINE2 =b.ADDRESS_LINE2 ,";
		sql_command += " target.BILL_TO =b.BILL_TO ,";
		sql_command += " target.BILL_TO_LINE2 =b.BILL_TO_LINE2 ,";
		sql_command += " target.CITY =b.CITY ,";
		sql_command += " target.COUNTRY =b.COUNTRY ,";
		sql_command += " target.STATE =b.STATE ,";
		sql_command += " target.ZIP =b.ZIP ,";
		sql_command += " target.CREDIT_FLAG =b.CREDIT_FLAG ,";
		sql_command += " target.DELINQUENT_DATE =b.DELINQUENT_DATE ,";
		sql_command += " target.PREVIOUS_BILL_KEY=b.PREVIOUS_BILL_KEY,";
		sql_command += " target.ETL_SOURCE_DATETIME=b.ETL_SOURCE_DATETIME , ";
		sql_command += " target.ETL_RECORD_UPDATED =current_timestamp()";
		sql_command += " WHEN NOT MATCHED THEN INSERT (BILL_KEY, ";
		sql_command += " BILL_NUMBER, ";
		sql_command += " BILL_ESTIMATE_FLAG, ";
		sql_command += " BILL_PAID_STATUS, ";
		sql_command += " BILL_TYPE, ";
		...
		sql_command += " ETL_RECORD_CREATED, ";
		sql_command += " ETL_RECORD_UPDATED)";
		sql_command += " VALUES (b.BILL_KEY, ";
		sql_command += " b.BILL_NUMBER ,";
		sql_command += " b.BILL_ESTIMATE_FLAG ,";
		sql_command += " b.BILL_PAID_STATUS ,";
		sql_command += " b.BILL_TYPE ,";
		sql_command += " b.BILL_DESCRIPTION ,";
		sql_command += " b.ADDRESS_LINE1 ,";
		sql_command += " b.ADDRESS_LINE2 ,";
		sql_command += " b.BILL_TO ,";
		sql_command += " b.BILL_TO_LINE2 ,";
		sql_command += " b.CITY ,";
		sql_command += " b.COUNTRY ,";
		sql_command += " b.STATE ,";
		sql_command += " b.ZIP ,";
		sql_command += " b.CREDIT_FLAG ,";
		sql_command += " b.DELINQUENT_DATE ,";
		sql_command += " b.PREVIOUS_BILL_KEY,";
