CREATE OR REPLACE PROCEDURE "SP0BLI_DIM_ACCOUNT_SERVICE"()
...
//  Run merge statement
			...
			sql_command += "  BILLLINEITEM.ACCOUNT_SERVICE_KEY,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_ACCOUNT_SERVICE ACCOUNTSERVICE ON BILLLINEITEM.ACCOUNT_SERVICE_KEY=ACCOUNTSERVICE.ACCOUNT_SERVICE_KEY";
			sql_command += "    WHERE ACCOUNTSERVICE.ACCOUNT_SERVICE_KEY IS NULL AND BILLLINEITEM.ACCOUNT_SERVICE_KEY IS NOT NULL";
