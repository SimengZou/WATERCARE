CREATE OR REPLACE PROCEDURE "SP0AT_DIM_TRANSACTION_COMMENTS"()
...
//  Run merge statement
	        ...
	        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_TRANSACTION_COMMENTS target USING (SELECT  ";
			sql_command += "  ACCTTRAN.TRANSACTION_COMMENTS_KEY,";
			sql_command += "  ''Not Available'' AS TRANSACTION_COMMENTS,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_TRANSACTION_COMMENTS TRANSACTION_COMMENTS ON ACCTTRAN.TRANSACTION_COMMENTS_KEY =TRANSACTION_COMMENTS.TRANSACTION_COMMENTS_KEY";
			sql_command += "    WHERE TRANSACTION_COMMENTS.TRANSACTION_COMMENTS_KEY IS NULL AND ACCTTRAN.TRANSACTION_COMMENTS_KEY IS NOT NULL";
			sql_command += " GROUP BY 1";
			sql_command += "  ) AS b ON target.TRANSACTION_COMMENTS_key =b.TRANSACTION_COMMENTS_key";
			sql_command += "  WHEN NOT MATCHED THEN INSERT (TRANSACTION_COMMENTS_KEY, ";
			...
			sql_command += "  VALUES (b.TRANSACTION_COMMENTS_KEY, ";
			sql_command += "  b.TRANSACTION_COMMENTS ,";
