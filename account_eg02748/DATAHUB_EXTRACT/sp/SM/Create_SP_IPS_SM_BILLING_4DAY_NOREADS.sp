//  Name:       sp_ips_sm_billing_4day_noreads
//
...
//  by job sp_ips_sm_billing_4day_noreads
...
create or replace procedure datahub_extract.sp_ips_sm_billing_4day_noreads()
    returns string
    language javascript
    execute as caller
    as
...
//  Truncate target table 
        ...
        snowflake.execute ({sqlText: "TRUNCATE TABLE DATAHUB_EXTRACT.IPS_SM_BILLING_4DAY_NOREADS;"});
...
//  Run insert statement  
        ...
        try
            {            
            var sqlStmt = snowflake.createStatement( {sqlText: ` INSERT INTO DATAHUB_EXTRACT.IPS_SM_BILLING_4DAY_NOREADS 
