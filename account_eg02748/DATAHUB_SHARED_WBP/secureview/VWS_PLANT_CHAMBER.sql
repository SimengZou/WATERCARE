CREATE OR REPLACE SECURE VIEW ${buildvar.env}_WBP_SHARE.DATAHUB_SHARED_WBP.VWS_PLANT_CHAMBER
AS
SELECT 
...
, XCHAMBER.BOLTDOWN           AS "Boltdown"
, XCHAMBER.COVERTYPE          AS "Cover Type"
, XCHAMBER.DIAMEXT            AS "Diameter External (mm)"
, XCHAMBER.DIAMINT            AS "Diameter Internal (mm)"
, XCHAMBER.HINGED             AS "Hinged"
, XCHAMBER.INVLEVEL           AS "Invert Level (M)"
, XCHAMBER.DROPMH             AS "Is Drop Manhole"
, XCHAMBER.LIDLEVEL           AS "Lid Level (M)"
, XCHAMBER.LOCKABLE           AS "Lockable"
, XCHAMBER.OVERFLOWTYPE       AS "Overflow Type"
, XCHAMBER.REMOVABLE          AS "Removable"
, XCHAMBER.SUBTYPEFEATURES    AS "SubType Features"
, A1.WARRANTYEND              AS "Warranty End Date"
, A1.WARRANTYSTART            AS "Warranty Start Date"
, XCHAMBER.DESIGNRESILIENCE   AS "Design Resilience"
, XCHAMBER.QUAKEDESIGN        AS "Earthquake Design Level"
, XCHAMBER.FALLPROTECT        AS "Fall Protection"
, XCHAMBER.FUNCAREA           AS "Functional Area"
, XCHAMBER.GRDLEVEL           AS "Ground Level"
, XCHAMBER.INTLINING          AS "Internal Lining"
, XCHAMBER.LOADRATING         AS "Load Rating (kN)"
, XCHAMBER.LOCALITY           AS "Locality"
, XCHAMBER.MEDIATYPE          AS "Media Type"
, XCHAMBER.PHOTO3D            AS "Photo/3D Model"
...
FROM
  ...
  LEFT OUTER JOIN "${buildvar.env}_WCC_DATAWAREHOUSE"."DATAHUB_TARGET".IPS_WSLASSETSCONFIGURED_XCHAMBER  AS XCHAMBER ON A2.COMPKEY = XCHAMBER.COMPKEY  
  WHERE A2.OWN = 'WBP' and A4.COMPCODE = 'CHAM';
