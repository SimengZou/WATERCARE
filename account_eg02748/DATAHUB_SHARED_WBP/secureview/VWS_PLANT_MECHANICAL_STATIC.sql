CREATE OR REPLACE SECURE VIEW ${buildvar.env}_WBP_SHARE.DATAHUB_SHARED_WBP.VWS_PLANT_MECHANICAL_STATIC
AS
SELECT 
...
, XMECHSTATIC.DIAMEXT                                AS "Diameter External (mm)"
, XMECHSTATIC.DIAMINT                                AS "Diameter Internal (mm)"
, XMECHSTATIC.ENERGYRATING                           AS "Energy Rating (Kw)"
, XMECHSTATIC.VOLTAGEIN                              AS "Input Voltage (Volt)"
, XMECHSTATIC.VOLTAGEINTYPE                          AS "Input Voltage Type"
, XMECHSTATIC.PHASES                                 AS "Phases"
, XMECHSTATIC.PRESSURERATING                         AS "Pressure Rating (kPa)"
, XMECHSTATIC.STAGES                                 AS "Stages"
, XMECHSTATIC.STIFFRATING                            AS "Stiffness Rating (SN)"
, XMECHSTATIC.SUBTYPEFEATURES                        AS "SubType Features"
, A1.WARRANTYEND               						 AS "Warranty End Date"
, A1.WARRANTYSTART             						 AS "Warranty Start Date"
, XMECHSTATIC.EXTCOAT                                AS "External Coating"
, XMECHSTATIC.FUNCAREA                               AS "Functional Area"
, XMECHSTATIC.HAZARDRATING                           AS "Hazardous Rating"
, XMECHSTATIC.IPRATING                               AS "Ingress Protection Rating"
, XMECHSTATIC.DIAMINLET                              AS "Inlet Diameter"
, XMECHSTATIC.INSTALLMOUNT                           AS "Installation Mounting"
, XMECHSTATIC.INTLINING                              AS "Internal Lining"
, XMECHSTATIC.JTTYPE                                 AS "Joint Method"
, XMECHSTATIC.LOCALITY                               AS "Locality"
, XMECHSTATIC.MAXFLOW                                AS "Maximum Flow"
, XMECHSTATIC.MINFLOW                                AS "Minimum Flow"
, XMECHSTATIC.MEDIATYPE                              AS "Media Type"
, XMECHSTATIC.DIAMOUTLET                             AS "Outlet Diameter"
, XMECHSTATIC.PHOTO3D                                AS "Photo/3D Model"
...
FROM
  ...
  LEFT OUTER JOIN "${buildvar.env}_WCC_DATAWAREHOUSE"."DATAHUB_TARGET".IPS_WSLASSETSCONFIGURED_XMECHSTATIC AS XMECHSTATIC ON A2.COMPKEY = XMECHSTATIC.COMPKEY 
  WHERE A2.OWN = 'WBP' and A4.COMPCODE = 'MECS';
