CREATE OR REPLACE SECURE VIEW ${buildvar.env}_WBP_SHARE.DATAHUB_SHARED_WBP.VWS_PLANT_ELECTRICAL_STATIC
AS
SELECT 
...
, XELECTSTATIC.ENERGYRATING                       AS "Energy Rating (Kw)"
, XELECTSTATIC.CURRENTIN                          AS "Input Current (Amps)"
, XELECTSTATIC.VOLTAGEIN                          AS "Input Voltage (Volt)"
, XELECTSTATIC.VOLTAGEINTYPE                      AS "Input Voltage Type"
, XELECTSTATIC.CURRENTOUT                         AS "Output Current (Amps)"
, XELECTSTATIC.VOLTAGEOUT                         AS "Output Voltage (Volt)"
, XELECTSTATIC.VOLTAGEOUTTYPE                     AS "Output Voltage Type"
, XELECTSTATIC.PHASES                             AS "Phases"
, XELECTSTATIC.SUBTYPEFEATURES                    AS "SubType Features"
, A1.WARRANTYEND            					  AS "Warranty End Date"
, A1.WARRANTYSTART          					  AS "Warranty Start Date"
, XELECTSTATIC.COMMSPROTOCOL                      AS "Communications Protocol"
, XELECTSTATIC.COOLING                            AS "Cooling"
, XELECTSTATIC.EXTCOAT                            AS "External Coating"
, XELECTSTATIC.FUNCAREA                           AS "Functional Area"
, XELECTSTATIC.HAZARDRATING                       AS "Hazardous Rating"
, XELECTSTATIC.IPRATING                           AS "Ingress Protection Rating"
, XELECTSTATIC.INSTALLMOUNT                       AS "Installation Mounting"
, XELECTSTATIC.INSULATIONCLASS                    AS "Insulation Class"
, XELECTSTATIC.LOCALITY                           AS "Locality"
, XELECTSTATIC.PHOTO3D                            AS "Photo/3D Model"
...
FROM
  ...
  LEFT OUTER JOIN "${buildvar.env}_WCC_DATAWAREHOUSE"."DATAHUB_TARGET"."IPS_WSLASSETSCONFIGURED_XELECTSTATIC" AS XELECTSTATIC ON A2.COMPKEY = XELECTSTATIC.COMPKEY 
  WHERE A2.OWN = 'WBP' and A4.COMPCODE = 'ELST';
