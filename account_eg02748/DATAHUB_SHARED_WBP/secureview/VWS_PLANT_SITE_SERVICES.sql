CREATE OR REPLACE SECURE VIEW ${buildvar.env}_WBP_SHARE.DATAHUB_SHARED_WBP.VWS_PLANT_SITE_SERVICES
AS
SELECT
...
, XSITESERVICES.BOLTDOWN                           AS "Boltdown"
, XSITESERVICES.COVERTYPE                          AS "Cover Type"
, XSITESERVICES.HINGED                             AS "Hinged"
, XSITESERVICES.LOCKABLE                           AS "Lockable"
, XSITESERVICES.REMOVABLE                          AS "Removable"
, XSITESERVICES.SUBTYPEFEATURES                    AS "SubType Features"
, A1.WARRANTYEND             					   AS "Warranty End Date"
, A1.WARRANTYSTART           					   AS "Warranty Start Date"
, XSITESERVICES.FUNCAREA                           AS "Functional Area"
, XSITESERVICES.PHOTO3D                            AS "Photo/3D Model"
...
FROM
  ...
  LEFT OUTER JOIN "${buildvar.env}_WCC_DATAWAREHOUSE"."DATAHUB_TARGET".IPS_WSLASSETSCONFIGURED_XSITESERVICES AS XSITESERVICES ON A2.COMPKEY = XSITESERVICES.COMPKEY 
  WHERE A2.OWN = 'WBP' and A4.COMPCODE = 'SISV';
