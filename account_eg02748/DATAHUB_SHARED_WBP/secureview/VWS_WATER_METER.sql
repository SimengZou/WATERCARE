CREATE OR REPLACE SECURE VIEW ${buildvar.env}_WBP_SHARE.DATAHUB_SHARED_WBP.VWS_WATER_METER
AS
SELECT
...
, A2."MFGKEY" AS "Manufacturer"
, A2."UNITID" AS "Meter ID"
, A2."METERSZ" AS "Meter Size"
, A2."UNITTYPE" AS "Meter Type Code"
, 'TBD' AS "Meter Type Description"
, A1."MODELNO" AS "Model #"
