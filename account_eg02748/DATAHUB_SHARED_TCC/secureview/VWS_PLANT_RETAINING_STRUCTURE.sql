CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_RETAINING_STRUCTURE
AS
SELECT 
...
, XRETAINSTRUCTURE.CAPACITY::FLOAT AS "Capacity (m3)"
, XRETAINSTRUCTURE.INHIBITLEVEL::FLOAT AS "Inhibit Level (M)"
, XRETAINSTRUCTURE.INVLEVEL::FLOAT AS "Invert Level (M)"
, XRETAINSTRUCTURE.OVERFLOWLEVEL::FLOAT AS "Overflow Level (M)"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XRETAINSTRUCTURE.DESIGNRESILIENCE::VARCHAR(10) AS "Design Resilience"
, XRETAINSTRUCTURE.DISCHARGECAP::FLOAT AS "Discharge Capacity (m3 per sec)"
, XRETAINSTRUCTURE.QUAKEDESIGN::VARCHAR(10) AS "Earthquake Design Level"
, XRETAINSTRUCTURE.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XRETAINSTRUCTURE.GRDLEVEL::FLOAT AS "Ground Level"
, XRETAINSTRUCTURE.INSTALLMOUNT::VARCHAR(1) AS "Installation Mounting"
, XRETAINSTRUCTURE.INTLINING::VARCHAR(10) AS "Internal Lining"
, XRETAINSTRUCTURE.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
, XRETAINSTRUCTURE.SPILLWAYTYPE::VARCHAR(10) AS "Spillway Type"
, XRETAINSTRUCTURE.AREA::FLOAT AS "Surface Area (m2)"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XRETAINSTRUTURE AS XRETAINSTRUCTURE ON A2.COMPKEY = XRETAINSTRUCTURE.COMPKEY 
 WHERE A4.COMPCODE = 'REST';