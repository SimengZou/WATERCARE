CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_ELECTRICAL_STATIC
AS
SELECT 
...
, XELECTSTATIC.ENERGYRATING::NUMBER(38,0) AS "Energy Rating (Kw)"
, XELECTSTATIC.CURRENTIN::FLOAT AS "Input Current (Amps)"
, XELECTSTATIC.VOLTAGEIN::FLOAT AS "Input Voltage (Volt)"
, XELECTSTATIC.VOLTAGEINTYPE::VARCHAR(2) AS "Input Voltage Type"
, XELECTSTATIC.CURRENTOUT::FLOAT AS "Output Current (Amps)"
, XELECTSTATIC.VOLTAGEOUT::FLOAT AS "Output Voltage (Volt)"
, XELECTSTATIC.VOLTAGEOUTTYPE::VARCHAR(2) AS "Output Voltage Type"
, XELECTSTATIC.PHASES::VARCHAR(10) AS "Phases"
, XELECTSTATIC.SUBTYPEFEATURES::VARCHAR(10) AS "SubType Features"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XELECTSTATIC.COMMSPROTOCOL::VARCHAR(10) AS "Communications Protocol"
, XELECTSTATIC.COOLING::VARCHAR(1) AS "Cooling"
, XELECTSTATIC.EXTCOAT::VARCHAR(10) AS "External Coating"
, XELECTSTATIC.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XELECTSTATIC.HAZARDRATING::VARCHAR(10) AS "Hazardous Rating"
, XELECTSTATIC.IPRATING::VARCHAR(10) AS "Ingress Protection Rating"
, XELECTSTATIC.INSTALLMOUNT::VARCHAR(1) AS "Installation Mounting"
, XELECTSTATIC.INSULATIONCLASS::VARCHAR(10) AS "Insulation Class"
, XELECTSTATIC.LOCALITY::VARCHAR(10) AS "Locality"
, XELECTSTATIC.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XELECTSTATIC AS XELECTSTATIC ON A2.COMPKEY = XELECTSTATIC.COMPKEY 
 WHERE A4.COMPCODE = 'ELST';
