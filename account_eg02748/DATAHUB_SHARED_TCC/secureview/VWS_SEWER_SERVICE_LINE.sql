CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_SEWER_SERVICE_LINE
AS
SELECT 
...
, A2."UNITID"::VARCHAR(50) AS "Service Line ID"
, A2."UNITTYPE"::VARCHAR(10) AS "Service Line Type"
, 'TBD'::VARCHAR(3) AS "Service Line Type Description"
...
, XSEWERSERVICELINE.DIAMEXT::FLOAT AS "Diameter External (mm)"
, XSEWERSERVICELINE.DIAMINT::FLOAT AS "Diameter Internal (mm)"
, XSEWERSERVICELINE.INVLEVEL::FLOAT AS "Invert Level (M)"
, XSEWERSERVICELINE.PRESSURERATING::FLOAT AS "Pressure Rating (kPa)"
, XSEWERSERVICELINE.STIFFRATING::FLOAT AS "Stiffness Rating (SN)"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XSEWERSERVICELINE.CONSTMETHOD::VARCHAR(10) AS "Construction Method"
, XSEWERSERVICELINE.DESIGNRESILIENCE::VARCHAR(10) AS "Design Resilience"
, XSEWERSERVICELINE.QUAKEDESIGN::VARCHAR(10) AS "Earthquake Design Level"
, XSEWERSERVICELINE.EXTCOAT::VARCHAR(10) AS "External Coating"
, XSEWERSERVICELINE.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XSEWERSERVICELINE.GRDLEVEL::FLOAT AS "Ground Level"
, XSEWERSERVICELINE.INTLINING::VARCHAR(10) AS "Internal Lining"
, XSEWERSERVICELINE.JTTYPE::VARCHAR(10) AS "Joint Method"
, XSEWERSERVICELINE.LOCALITY::VARCHAR(10) AS "Locality"
, XSEWERSERVICELINE.MEDIATYPE::VARCHAR(10) AS "Media Type"
, XSEWERSERVICELINE.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 "DATAHUB_TARGET"."IPS_ASSETMANAGEMENT_SEWER_COMPSSL" AS A2
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSSEWER_XSEWERSERVICELINE AS XSEWERSERVICELINE ON A2.COMPKEY = XSEWERSERVICELINE.COMPKEY 
