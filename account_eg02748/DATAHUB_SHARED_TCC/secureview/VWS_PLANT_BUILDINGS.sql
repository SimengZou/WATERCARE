create or replace secure view DATAHUB_SHARED_TCC.VWS_PLANT_BUILDINGS
AS
SELECT 
...
, XBUILDINGS.DESIGNRESILIENCE::VARCHAR(10) AS "Design Resilience"
, XBUILDINGS.QUAKEDESIGN::VARCHAR(10) AS "Earthquake Design Level"
, XBUILDINGS.EXTCOAT::VARCHAR(10) AS "External Coating"
, XBUILDINGS.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XBUILDINGS.GRDLEVEL::FLOAT AS "Ground Level"
, XBUILDINGS.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
, XBUILDINGS.AREA::NUMBER(38,0) AS "Surface Area (m2)"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XBUILDINGS AS XBUILDINGS ON A2.COMPKEY = XBUILDINGS.COMPKEY 
 WHERE A4.COMPCODE = 'BLDS';