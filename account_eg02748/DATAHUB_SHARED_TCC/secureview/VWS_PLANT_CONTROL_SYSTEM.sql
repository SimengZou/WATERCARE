CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_CONTROL_SYSTEM
AS
SELECT 
...
, XCONTROLSYS.ENERGYRATING::NUMBER(38,0) AS "Energy Rating (Kw)"
, XCONTROLSYS.VOLTAGEIN::FLOAT AS "Input Voltage (Volt)"
, XCONTROLSYS.VOLTAGEINTYPE::VARCHAR(2) AS "Input Voltage Type"
, XCONTROLSYS.VOLTAGEOUT::FLOAT AS "Output Voltage (Volt)"
, XCONTROLSYS.VOLTAGEOUTTYPE::VARCHAR(2) AS "Output Voltage Type"
, XCONTROLSYS.STFCABINET::VARCHAR(1) AS "STF Cabinet"
, XCONTROLSYS.STFFAN::VARCHAR(1) AS "STF Fan"
, XCONTROLSYS.STFFILTER::VARCHAR(1) AS "STF Filter"
, XCONTROLSYS.STFHEATER::VARCHAR(1) AS "STF Heater"
, XCONTROLSYS.STFLIGHTARRESTOR::VARCHAR(1) AS "STF Lightening Arrestor"
, XCONTROLSYS.STFREDUNDANCY::VARCHAR(1) AS "STF Redundancy Module"
, XCONTROLSYS.STFSTANDBYUNIT::VARCHAR(1) AS "STF Standby Unit"
, XCONTROLSYS.STFTEMP::VARCHAR(1) AS "STF Temperature Monitor"
, XCONTROLSYS.STFTRANSCEIVER::VARCHAR(1) AS "STF Transceiver"
, XCONTROLSYS.STFVENT::VARCHAR(1) AS "STF Vent"
, XCONTROLSYS.SUBTYPEFEATURES::VARCHAR(10) AS "SubType Features"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XCONTROLSYS.COMMSPROTOCOL::VARCHAR(10) AS "Communications Protocol"
, XCONTROLSYS.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XCONTROLSYS.GRDLEVEL::FLOAT AS "Ground Level"
, XCONTROLSYS.HAZARDRATING::VARCHAR(10) AS "Hazardous Rating"
, XCONTROLSYS.IPRATING::VARCHAR(10) AS "Ingress Protection Rating"
, XCONTROLSYS.INSTRUMENTRANGE::VARCHAR(30) AS "Instrument Range"
, XCONTROLSYS.INSULATIONCLASS::VARCHAR(10) AS "Insulation Class"
, XCONTROLSYS.LOCALITY::VARCHAR(10) AS "Locality"
, XCONTROLSYS.MEDIATYPE::VARCHAR(10) AS "Media Type"
, XCONTROLSYS.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XCONTROLSYS AS XCONTROLSYS ON A2.COMPKEY = XCONTROLSYS.COMPKEY 
 WHERE A4.COMPCODE = 'CNTS';