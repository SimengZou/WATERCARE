CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_WATER_SERVICE_LINE
AS
SELECT 
...
, A2."UNITTYPE"::VARCHAR(10) AS "Service Line Type Code"
...
, XWATERSERVICELINE.DIAMEXT::FLOAT AS "Diameter External (mm)"
, XWATERSERVICELINE.DIAMINT::FLOAT AS "Diameter Internal (mm)"
, XWATERSERVICELINE.INVLEVEL::FLOAT AS "Invert Level (M)"
, XWATERSERVICELINE.PRESSURERATING::FLOAT AS "Pressure Rating (kPa)"
, XWATERSERVICELINE.STIFFRATING::FLOAT AS "Stiffness Rating (SN)"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XWATERSERVICELINE.CONSTMETHOD::VARCHAR(10) AS "Construction Method"
, XWATERSERVICELINE.DESIGNRESILIENCE::VARCHAR(10) AS "Design Resilience"
, XWATERSERVICELINE.QUAKEDESIGN::VARCHAR(10) AS "Earthquake Design Level"
, XWATERSERVICELINE.EXTCOAT::VARCHAR(10) AS "External Coating"
, XWATERSERVICELINE.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XWATERSERVICELINE.GRDLEVEL::FLOAT AS "Ground Level"
, XWATERSERVICELINE.INTLINING::VARCHAR(10) AS "Internal Lining"
, 'TBD XWATERSERVICELINE.JTTYPE'::VARCHAR(28) AS "Joint Method"
, XWATERSERVICELINE.LOCALITY::VARCHAR(10) AS "Locality"
, XWATERSERVICELINE.MEDIATYPE::VARCHAR(10) AS "Media Type"
, XWATERSERVICELINE.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 "DATAHUB_TARGET"."IPS_ASSETMANAGEMENT_WATER_COMPWSL" AS A2
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSWATER_XWATERSERVICELINE AS XWATERSERVICELINE ON A2.COMPKEY = XWATERSERVICELINE.COMPKEY 
