CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_ROADS_BRIDGES
AS
SELECT
...
, XROADSNBRIDGES.INVLEVEL::FLOAT AS "Invert Level (M)"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XROADSNBRIDGES.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XROADSNBRIDGES.GRDLEVEL::FLOAT AS "Ground Level"
, XROADSNBRIDGES.LOADRATING::FLOAT AS "Load Rating (kN)"
, XROADSNBRIDGES.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XROADSNBRIDGES AS XROADSNBRIDGES ON A2.COMPKEY = XROADSNBRIDGES.COMPKEY 
 WHERE A4.COMPCODE = 'ROBR';
