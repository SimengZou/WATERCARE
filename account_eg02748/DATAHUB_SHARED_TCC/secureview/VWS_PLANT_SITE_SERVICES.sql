CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_SITE_SERVICES
AS
SELECT
...
, XSITESERVICES.BOLTDOWN::VARCHAR(1) AS "Boltdown"
, XSITESERVICES.COVERTYPE::VARCHAR(10) AS "Cover Type"
, XSITESERVICES.HINGED::VARCHAR(1) AS "Hinged"
, XSITESERVICES.LOCKABLE::VARCHAR(1) AS "Lockable"
, XSITESERVICES.REMOVABLE::VARCHAR(1) AS "Removable"
, XSITESERVICES.SUBTYPEFEATURES::VARCHAR(10) AS "SubType Features"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XSITESERVICES.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XSITESERVICES.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XSITESERVICES AS XSITESERVICES ON A2.COMPKEY = XSITESERVICES.COMPKEY 
 WHERE A4.COMPCODE = 'SISV';
