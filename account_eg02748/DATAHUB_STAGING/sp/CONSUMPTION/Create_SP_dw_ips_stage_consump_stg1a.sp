//  Name:       sp_dw_ips_stage_consump_stg1a
//
//  Purpose:    Load consumption data - staging table dw_ips_stage_consump_stg1a for job sp_dw_ips_stage_consump_stg1a
//
//  Description:
//
...
create or replace procedure datahub_staging.sp_dw_ips_stage_consump_stg1a()
    returns string
    language javascript
    execute as caller
    as
...
//  Truncate target table 
        ...
        snowflake.execute ({sqlText: "TRUNCATE TABLE DATAHUB_STAGING.DW_IPS_STAGE_CONSUMP_STG1a;"});
...
//  Run insert statement
	 ...
	 //   snowflake.execute({sqlText: sql_command});
        ...
        try
            ...
            var sqlStmt = snowflake.createStatement( {sqlText: ` INSERT INTO DATAHUB_STAGING.DW_IPS_STAGE_CONSUMP_STG1a
		 (SEQ, COMPKEY, READINGKEY, READING, MAXREAD, CONSUMP)
		 SELECT  t1.SEQ, t1.COMPKEY, t1.READINGKEY, t1.READING, t1.MAXREAD, t1.reading - t2.reading AS consump
