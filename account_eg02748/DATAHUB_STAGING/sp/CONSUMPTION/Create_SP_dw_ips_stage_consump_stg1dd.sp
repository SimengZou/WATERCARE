//  Name:       sp_dw_ips_stage_consump_stg1dd
//
//  Purpose:    Load consumption data - update staging table dw_ips_stage_consump_stg1 from table dw_ips_stage_consump_stg1c
//
//  Description:
//
...
create or replace procedure datahub_staging.sp_dw_ips_stage_consump_stg1dd()
    returns string
    language javascript
    execute as caller
    as
...
//  Run update statement
        ...
        try
            ...
            var sqlStmt = snowflake.createStatement( {sqlText:  ` UPDATE datahub_staging.dw_ips_stage_consump_stg1 t1
		 set t1.consump=t2.consump
		 from datahub_staging.dw_ips_stage_consump_stg1d t2
		 WHERE t1.compkey=t2.compkey AND t1.seq=t2.seq; `} );
