//  Name:       sp_dw_ips_stage_consump_stg1b
//
//  Purpose:    Load consumption data - staging table dw_ips_stage_consump_stg1b loaded by job sp_dw_ips_stage_consump_stg1b
//
//  Description:
//
...
create or replace procedure datahub_staging.sp_dw_ips_stage_consump_stg1b()
    returns string
    language javascript
    execute as caller
    as
...
//  Truncate target table 
        ...
        snowflake.execute ({sqlText: "TRUNCATE TABLE DATAHUB_STAGING.DW_IPS_STAGE_CONSUMP_STG1b;"});
...
//  Run insert statement
        ...
        try
            ...
            var sqlStmt = snowflake.createStatement( {sqlText: `INSERT INTO DATAHUB_STAGING.DW_IPS_STAGE_CONSUMP_STG1b
         ...
         and t1.seq in (select max(seq) from datahub_staging.dw_ips_stage_consump_stg1 where compkey=t1.compkey);`} );
