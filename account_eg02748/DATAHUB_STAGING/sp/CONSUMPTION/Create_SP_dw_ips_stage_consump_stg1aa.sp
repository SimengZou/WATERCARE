//  Name:       sp_dw_ips_stage_consump_stg1aa
//
//  Purpose:    Load consumption data - update staging table dw_ips_stage_consump_stg1 from table dw_ips_stage_consump_stg1a
//
//  Description:
//
...
create or replace procedure datahub_staging.sp_dw_ips_stage_consump_stg1aa()
    returns string
    language javascript
    execute as caller
    as
...
//  Run update statement
        ...
        try
		 ...
		 from datahub_staging.dw_ips_stage_consump_stg1a t2
