//  Name:       sp_dw_ips_stage_consump_stg1cc
//
...
create or replace procedure datahub_staging.sp_dw_ips_stage_consump_stg1cc()
    returns string
    language javascript
    execute as caller
    as
...
//  Run update statement
        ...
        try
		 ...
		 from datahub_staging.dw_ips_stage_consump_stg1c t2
