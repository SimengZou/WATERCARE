create or replace view VW_ICARE_CASE_CLOSE_CALL_API_JSON as 
...
value:serious_close_call::varchar as "SERIOUS_CLOSE_CALL",
...
value:consequences::varchar as "CONSEQUENCES",
...
--,SYSDATE() as ETL_LOAD_DATETIME
  ...
  from
    ...
    DATAHUB_LANDING.ICARE_CASE_CLOSE_CALL_API
