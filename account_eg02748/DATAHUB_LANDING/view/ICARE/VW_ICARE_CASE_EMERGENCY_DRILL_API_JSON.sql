create or replace view VW_ICARE_CASE_EMERGENCY_DRILL_API_JSON as 
...
value:is_exit_clear::varchar as "IS_EXIT_CLEAR",

value:is_evac_no_injury_detail::varchar as "IS_EVAC_NO_INJURY_DETAIL",
...
value:evacuation_time::varchar as "EVACUATION_TIME",

value:is_evac_alarm_clear::varchar as "IS_EVAC_ALARM_CLEAR",
...
value:evacuation_type::varchar as "EVACUATION_TYPE",

value:is_evac_no_injury::varchar as "IS_EVAC_NO_INJURY",

value:urgency::varchar as "URGENCY",

value:is_evac_alarm_clear_detail::varchar as "IS_EVAC_ALARM_CLEAR_DETAIL",
...
value:is_everyone_accounted_for::varchar as "IS_EVERYONE_ACCOUNTED_FOR",
...
value:warden_names::varchar as "WARDEN_NAMES",

value:is_exit_clear_detail::varchar as "IS_EXIT_CLEAR_DETAIL",
...
value:is_evac_equipment_working::varchar as "IS_EVAC_EQUIPMENT_WORKING",

value:escalation::varchar as "ESCALATION",

value:upon_approval::varchar as "UPON_APPROVAL",

value:is_self_evac_system_working::varchar as "IS_SELF_EVAC_SYSTEM_WORKING",
...
--,SYSDATE() as ETL_LOAD_DATETIME
  ...
  from
    ...
    DATAHUB_LANDING.ICARE_CASE_EMERGENCY_DRILL_API
