create or replace view VW_ICARE_CASE_PERMIT_AUDIT_API_JSON as 
...
value:permit_number::varchar as "PERMIT_NUMBER",
...
value:work_permit_match::varchar as "WORK_PERMIT_MATCH",
...
value:have_workers_been_briefed::varchar as "HAVE_WORKERS_BEEN_BRIEFED",

value:permit_location_match::varchar as "PERMIT_LOCATION_MATCH",
...
value:is_permit_displayed::varchar as "IS_PERMIT_DISPLAYED",
...
value:is_supervised::varchar as "IS_SUPERVISED",
...
value:has_issuer_approved_permit::varchar as "HAS_ISSUER_APPROVED_PERMIT",
...
value:is_work_area_safe::varchar as "IS_WORK_AREA_SAFE",
...
--,SYSDATE() as ETL_LOAD_DATETIME
  ...
  from
    ...
    DATAHUB_LANDING.ICARE_CASE_PERMIT_AUDIT_API 
