create or replace procedure DATAHUB_INTEGRATION.SP_LN_TPPPC216()
...
try
    {
        var sql_command = `
                            ...
                            SELECT * FROM LANDING_ERROR.VW_STREAM_LN_TPPPC216_ERROR`;
    var sqlStmt = snowflake.createStatement( {sqlText:  sql_command} );
    var rs = sqlStmt.execute();
        
        var sql_command = ` 
                            merge into  TARGET_LN.LN_TPPPC216 as target using (SELECT * FROM (SELECT 
            strm.amoc, 
            strm.amoc_cntc, 
            strm.amoc_dwhc, 
            strm.amoc_homc, 
        ...
        FROM DATAHUB_INTEGRATION.VW_STREAM_LN_TPPPC216 as  strm
                    )   
            WHERE ROWNUMBER=1  
    ...
    snowflake.execute( {sqlText: `merge into TARGET_HISTORY_LN.LN_TPPPC216_DELETED as target using (
                SELECT * FROM (SELECT 
            strm.amoc, 
            strm.amoc_cntc, 
            strm.amoc_dwhc, 
