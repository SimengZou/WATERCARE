CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_EAM_U5ASSETSUBTYPES AS SELECT
                        src:AST_ASSETSUBTYPE::varchar AS AST_ASSETSUBTYPE, 
                        src:AST_ASSETTYPE::varchar AS AST_ASSETTYPE, 
