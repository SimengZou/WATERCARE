CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_IPS_WSLCDRPROJ_XAPPLICANTDP AS SELECT
                        ...
                        src:XAPPLICANTDPKEY::integer AS XAPPLICANTDPKEY, src:VARIATION_ID::integer as ETL_SEQUENCE_NUMBER,
            CASE
                WHEN 'IPS' = 'LN'
