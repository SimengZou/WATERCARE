CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_IPS_ASSETMANAGEMENT_WATER_COMPWV AS SELECT
                        ...
                        src:HIGHPRES::numeric(38, 10) AS HIGHPRES, 
                        src:HIGHPRESUOM::varchar AS HIGHPRESUOM, 
                        src:INSTDATE::datetime AS INSTDATE, 
                        src:INTKEY::integer AS INTKEY, 
                        src:LOC::varchar AS LOC, 
                        src:LOWPRES::numeric(38, 10) AS LOWPRES, 
                        src:LOWPRESUOM::varchar AS LOWPRESUOM, 
                        ...
                        src:VALVESZ::numeric(38, 10) AS VALVESZ, 
                        src:VALVESZUOM::varchar AS VALVESZUOM, 
            ...
            src:VARIATION_ID desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
                ...
                ROWNUMBER=1) where 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:HIGHPRES), '0'), 38, 10) is not null and 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:LOWPRES), '0'), 38, 10) is not null and 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:VALVESZ), '0'), 38, 10) is not null and 
