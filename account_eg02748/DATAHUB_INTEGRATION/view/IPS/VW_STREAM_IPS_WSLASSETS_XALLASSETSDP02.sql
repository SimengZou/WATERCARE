CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_IPS_WSLASSETS_XALLASSETSDP02 AS SELECT
                        ...
                        src:DATACHANGED::varchar AS DATACHANGED, 
                        ...
                        src:NEWCHANGE::varchar AS NEWCHANGE, 
                        ...
                        src:XALLASSETSDP02KEY::integer AS XALLASSETSDP02KEY, 
            ...
            src:VARIATION_ID desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
                ...
                ROWNUMBER=1) where 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:XALLASSETSDP02KEY), '0'), 38, 10) is not null and 
