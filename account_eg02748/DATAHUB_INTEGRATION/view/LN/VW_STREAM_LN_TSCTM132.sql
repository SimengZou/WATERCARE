CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_LN_TSCTM132 AS SELECT
                        ...
                        src:alhr::numeric(38, 17) AS alhr, 
                        src:alhr_butm::numeric(38, 17) AS alhr_butm, 
                        ...
                        src:chlt::varchar AS chlt, 
                        src:chlt_ref_compnr::integer AS chlt_ref_compnr, 
                        ...
                        src:ctsk_ref_compnr::integer AS ctsk_ref_compnr, 
                        src:deleted::boolean AS deleted, 
                        src:dspc::integer AS dspc, 
                        src:dspc_kw::varchar AS dspc_kw, 
                        src:eahr::numeric(38, 17) AS eahr, 
                        src:eahr_butm::numeric(38, 17) AS eahr_butm, 
                        ...
                        src:nrhr::numeric(38, 17) AS nrhr, 
                        src:nrhr_butm::numeric(38, 17) AS nrhr_butm, 
                        ...
                        src:sphr::numeric(38, 17) AS sphr, 
            ...
            src:sequencenumber desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
                ...
                ROWNUMBER=1) where 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:alhr), '0'), 38, 10) is not null and 
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:alhr_butm), '0'), 38, 10) is not null and 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:chlt_ref_compnr), '0'), 38, 10) is not null and 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:ctsk_ref_compnr), '0'), 38, 10) is not null and 
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:dspc), '0'), 38, 10) is not null and 
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:eahr), '0'), 38, 10) is not null and 
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:eahr_butm), '0'), 38, 10) is not null and 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:nrhr), '0'), 38, 10) is not null and 
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:nrhr_butm), '0'), 38, 10) is not null and 
                    ...
                    TRY_TO_NUMERIC(nvl(AS_VARCHAR(src:sphr), '0'), 38, 10) is not null and 
