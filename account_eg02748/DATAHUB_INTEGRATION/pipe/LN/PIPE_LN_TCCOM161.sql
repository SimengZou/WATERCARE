create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCCOM161 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCCOM161
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCCOM161(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));