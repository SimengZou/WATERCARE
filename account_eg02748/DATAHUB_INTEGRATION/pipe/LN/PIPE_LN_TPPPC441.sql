create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPPC441 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPPC441
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPPC441(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));