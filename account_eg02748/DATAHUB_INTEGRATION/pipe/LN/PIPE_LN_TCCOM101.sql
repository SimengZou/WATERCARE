create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCCOM101 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCCOM101
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCCOM101(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));