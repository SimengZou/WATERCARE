create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TXPDM904 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TXPDM904
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TXPDM904(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));