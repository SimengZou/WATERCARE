create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TSSOC205 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TSSOC205
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TSSOC205(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));