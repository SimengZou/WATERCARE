create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TDSMI007 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TDSMI007
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TDSMI007(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));