create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPDM063 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPDM063
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPDM063(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));