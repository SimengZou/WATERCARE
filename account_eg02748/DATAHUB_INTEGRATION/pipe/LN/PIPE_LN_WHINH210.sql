create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_WHINH210 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_WHINH210
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_WHINH210(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));