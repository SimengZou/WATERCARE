create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCMCS013 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCMCS013
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCMCS013(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));