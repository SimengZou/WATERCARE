create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TSCTM480 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TSCTM480
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TSCTM480(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));