create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFGLD482 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFGLD482
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFGLD482(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));