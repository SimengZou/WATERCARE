create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPPC411 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPPC411
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPPC411(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));