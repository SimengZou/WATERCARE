create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TSCTM135 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TSCTM135
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TSCTM135(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));