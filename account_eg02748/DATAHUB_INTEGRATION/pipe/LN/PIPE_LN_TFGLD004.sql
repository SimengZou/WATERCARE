create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFGLD004 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFGLD004
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFGLD004(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));