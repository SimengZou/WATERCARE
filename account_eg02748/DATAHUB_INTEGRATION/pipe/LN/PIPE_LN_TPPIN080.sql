create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPIN080 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPIN080
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPIN080(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));