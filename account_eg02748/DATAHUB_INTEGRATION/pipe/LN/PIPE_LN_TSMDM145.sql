create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TSMDM145 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TSMDM145
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TSMDM145(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));