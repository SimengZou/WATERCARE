create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCCOM100 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCCOM100
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCCOM100(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));