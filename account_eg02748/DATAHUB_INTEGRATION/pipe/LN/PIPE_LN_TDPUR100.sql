create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TDPUR100 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TDPUR100
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TDPUR100(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));