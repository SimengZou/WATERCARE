create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TSCTM320 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TSCTM320
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TSCTM320(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));