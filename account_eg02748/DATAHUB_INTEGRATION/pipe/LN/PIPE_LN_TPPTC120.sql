create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPTC120 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPTC120
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPTC120(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));