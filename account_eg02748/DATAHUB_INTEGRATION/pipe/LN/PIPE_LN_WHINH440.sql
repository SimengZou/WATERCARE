create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_WHINH440 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_WHINH440
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_WHINH440(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));