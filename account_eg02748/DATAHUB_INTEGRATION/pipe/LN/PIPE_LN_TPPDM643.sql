create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPDM643 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPDM643
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPDM643(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));