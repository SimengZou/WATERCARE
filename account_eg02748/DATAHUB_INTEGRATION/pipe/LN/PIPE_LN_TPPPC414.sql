create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPPC414 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPPC414
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPPC414(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));