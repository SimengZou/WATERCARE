create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCCOM122 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCCOM122
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCCOM122(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));