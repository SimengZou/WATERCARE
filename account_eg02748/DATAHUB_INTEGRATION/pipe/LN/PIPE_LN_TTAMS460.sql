create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TTAMS460 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TTAMS460
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TTAMS460(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));