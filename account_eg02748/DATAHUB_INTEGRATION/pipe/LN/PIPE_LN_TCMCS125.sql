create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCMCS125 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCMCS125
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCMCS125(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));