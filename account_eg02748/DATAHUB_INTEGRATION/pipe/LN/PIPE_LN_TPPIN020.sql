create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPIN020 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPIN020
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPIN020(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));