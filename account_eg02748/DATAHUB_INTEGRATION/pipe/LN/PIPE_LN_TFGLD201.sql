create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFGLD201 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFGLD201
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFGLD201(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));