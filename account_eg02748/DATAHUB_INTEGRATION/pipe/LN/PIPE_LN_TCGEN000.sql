create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCGEN000 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCGEN000
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCGEN000(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));