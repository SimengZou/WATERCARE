create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPDM065 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPDM065
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPDM065(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));