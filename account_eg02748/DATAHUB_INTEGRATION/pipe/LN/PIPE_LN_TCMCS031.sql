create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCMCS031 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCMCS031
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCMCS031(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));