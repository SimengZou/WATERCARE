create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFGLD003 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFGLD003
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFGLD003(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));