create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TXPDM902 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TXPDM902
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TXPDM902(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));