create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCCCP060 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCCCP060
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCCCP060(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));