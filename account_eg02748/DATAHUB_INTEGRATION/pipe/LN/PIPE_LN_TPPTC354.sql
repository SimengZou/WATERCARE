create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPTC354 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPTC354
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPTC354(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));