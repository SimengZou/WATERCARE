create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TDSLS094 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TDSLS094
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TDSLS094(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));