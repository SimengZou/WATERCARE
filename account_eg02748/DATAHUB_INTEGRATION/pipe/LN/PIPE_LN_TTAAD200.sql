create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TTAAD200 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TTAAD200
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TTAAD200(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));