create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPPC470 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPPC470
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPPC470(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));