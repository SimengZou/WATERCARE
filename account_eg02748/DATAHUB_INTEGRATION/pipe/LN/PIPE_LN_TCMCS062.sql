create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCMCS062 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCMCS062
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCMCS062(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));