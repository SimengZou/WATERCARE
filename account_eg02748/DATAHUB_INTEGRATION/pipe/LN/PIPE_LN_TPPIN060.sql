create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPIN060 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPIN060
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPIN060(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));