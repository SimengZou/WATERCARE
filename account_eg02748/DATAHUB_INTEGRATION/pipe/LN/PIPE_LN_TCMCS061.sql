create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCMCS061 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCMCS061
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCMCS061(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));