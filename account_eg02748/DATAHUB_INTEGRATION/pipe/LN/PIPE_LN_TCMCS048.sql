create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCMCS048 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCMCS048
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCMCS048(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));