create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TTAAD111 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TTAAD111
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TTAAD111(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));