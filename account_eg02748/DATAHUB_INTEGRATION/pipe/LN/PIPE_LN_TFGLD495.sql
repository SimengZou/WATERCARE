create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFGLD495 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFGLD495
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFGLD495(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));