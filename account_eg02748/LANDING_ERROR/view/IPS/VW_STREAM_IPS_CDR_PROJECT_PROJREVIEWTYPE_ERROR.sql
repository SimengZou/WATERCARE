CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_PROJECT_PROJREVIEWTYPE_ERROR AS SELECT src, 'IPS_CDR_PROJECT_PROJREVIEWTYPE' as TABLE_OBJECT, CASE WHEN 
