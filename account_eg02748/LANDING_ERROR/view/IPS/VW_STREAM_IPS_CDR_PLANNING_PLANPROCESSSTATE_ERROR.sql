CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_PLANNING_PLANPROCESSSTATE_ERROR AS SELECT src, 'IPS_CDR_PLANNING_PLANPROCESSSTATE' as TABLE_OBJECT, CASE WHEN 
