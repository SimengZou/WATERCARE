CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_PORTAL_MEMBERSHIPSINROLES_ERROR AS SELECT src, 'IPS_PORTAL_MEMBERSHIPSINROLES' as TABLE_OBJECT, CASE WHEN 
