CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_WSLCDRPROJ_XCDRPROJQUOTEACCEPTDP_ERROR AS SELECT src, 'IPS_WSLCDRPROJ_XCDRPROJQUOTEACCEPTDP' as TABLE_OBJECT, CASE WHEN 
