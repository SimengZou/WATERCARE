CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_ASSETMANAGEMENT_WATER_COMPWMC_ERROR AS SELECT src, 'IPS_ASSETMANAGEMENT_WATER_COMPWMC' as TABLE_OBJECT, CASE WHEN 
