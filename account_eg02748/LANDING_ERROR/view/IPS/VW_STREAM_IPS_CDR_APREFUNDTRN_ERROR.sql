CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_APREFUNDTRN_ERROR AS SELECT src, 'IPS_CDR_APREFUNDTRN' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:REFUNDAMT), '0'), 38, 10) is null and 
                    src:REFUNDAMT is not null) THEN
                    'REFUNDAMT contains a non-numeric value : \'' || AS_VARCHAR(src:REFUNDAMT) || '\'' WHEN 
