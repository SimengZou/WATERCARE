CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_ASSETMANAGEMENT_SEWER_COMPSMS_ERROR AS SELECT src, 'IPS_ASSETMANAGEMENT_SEWER_COMPSMS' as TABLE_OBJECT, CASE WHEN 
