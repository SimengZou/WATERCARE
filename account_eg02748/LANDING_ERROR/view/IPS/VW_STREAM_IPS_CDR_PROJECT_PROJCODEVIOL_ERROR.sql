CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_PROJECT_PROJCODEVIOL_ERROR AS SELECT src, 'IPS_CDR_PROJECT_PROJCODEVIOL' as TABLE_OBJECT, CASE WHEN 
