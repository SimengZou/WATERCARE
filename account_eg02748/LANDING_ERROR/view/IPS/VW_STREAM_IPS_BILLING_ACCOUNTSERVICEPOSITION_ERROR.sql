CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_BILLING_ACCOUNTSERVICEPOSITION_ERROR AS SELECT src, 'IPS_BILLING_ACCOUNTSERVICEPOSITION' as TABLE_OBJECT, CASE WHEN 
