CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_WSLCODESASSETSWATER_CONTRACTORPROJECTREF_ERROR AS SELECT src, 'IPS_WSLCODESASSETSWATER_CONTRACTORPROJECTREF' as TABLE_OBJECT, CASE WHEN 
