CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_BUILDING_BLDGLOGTYPE_ERROR AS SELECT src, 'IPS_CDR_BUILDING_BLDGLOGTYPE' as TABLE_OBJECT, CASE WHEN 
