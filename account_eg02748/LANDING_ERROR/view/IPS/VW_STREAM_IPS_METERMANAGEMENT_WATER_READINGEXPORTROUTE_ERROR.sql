CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_METERMANAGEMENT_WATER_READINGEXPORTROUTE_ERROR AS SELECT src, 'IPS_METERMANAGEMENT_WATER_READINGEXPORTROUTE' as TABLE_OBJECT, CASE WHEN 
