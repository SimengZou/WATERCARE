CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_PROJECT_PROJSTATUSCODE_ERROR AS SELECT src, 'IPS_CDR_PROJECT_PROJSTATUSCODE' as TABLE_OBJECT, CASE WHEN 
