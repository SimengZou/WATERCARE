CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CRM_SRINSP_ERROR AS SELECT src, 'IPS_CRM_SRINSP' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:SRINSPKEY), '0'), 38, 10) is null and 
                    src:SRINSPKEY is not null) THEN
                    'SRINSPKEY contains a non-numeric value : \'' || AS_VARCHAR(src:SRINSPKEY) || '\'' WHEN 
