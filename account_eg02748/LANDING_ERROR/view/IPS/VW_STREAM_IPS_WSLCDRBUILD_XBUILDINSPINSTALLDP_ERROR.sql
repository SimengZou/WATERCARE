CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_WSLCDRBUILD_XBUILDINSPINSTALLDP_ERROR AS SELECT src, 'IPS_WSLCDRBUILD_XBUILDINSPINSTALLDP' as TABLE_OBJECT, CASE WHEN 
