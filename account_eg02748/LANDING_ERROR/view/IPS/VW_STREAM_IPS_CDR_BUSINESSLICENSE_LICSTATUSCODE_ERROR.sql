CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_BUSINESSLICENSE_LICSTATUSCODE_ERROR AS SELECT src, 'IPS_CDR_BUSINESSLICENSE_LICSTATUSCODE' as TABLE_OBJECT, CASE WHEN 
