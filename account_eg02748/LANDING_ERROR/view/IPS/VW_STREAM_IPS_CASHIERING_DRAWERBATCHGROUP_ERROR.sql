CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CASHIERING_DRAWERBATCHGROUP_ERROR AS SELECT src, 'IPS_CASHIERING_DRAWERBATCHGROUP' as TABLE_OBJECT, CASE WHEN 
