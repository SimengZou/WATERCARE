CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_METERMANAGEMENT_WATER_READINGIMPORTROUTEDETAIL_ERROR AS SELECT src, 'IPS_METERMANAGEMENT_WATER_READINGIMPORTROUTEDETAIL' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:NOOFMETERS), '0'), 38, 10) is null and 
                    src:NOOFMETERS is not null) THEN
                    'NOOFMETERS contains a non-numeric value : \'' || AS_VARCHAR(src:NOOFMETERS) || '\'' WHEN 
