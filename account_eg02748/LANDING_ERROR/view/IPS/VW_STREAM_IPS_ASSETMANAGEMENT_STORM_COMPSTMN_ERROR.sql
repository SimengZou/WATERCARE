CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_ASSETMANAGEMENT_STORM_COMPSTMN_ERROR AS SELECT src, 'IPS_ASSETMANAGEMENT_STORM_COMPSTMN' as TABLE_OBJECT, CASE WHEN 
