CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_USE_USEREVIEWDETAILTYPE_ERROR AS SELECT src, 'IPS_CDR_USE_USEREVIEWDETAILTYPE' as TABLE_OBJECT, CASE WHEN 
