CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_EAM_R5ACTIVITIES
            AS
            SELECT
                ...
                src:"ACT_ACT"::numeric(38, 10),
                src:"ACT_EVENT"::varchar,
                src:"ACT_LASTSAVED"::datetime
                ,src,
                etl_load_datetime,
                etl_load_metadatafilename,
                ...
                src:"ACT_ACT"::numeric(38, 10),
                src:"ACT_EVENT"::varchar  ORDER BY 
                src:"ACT_LASTSAVED"::datetime desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
