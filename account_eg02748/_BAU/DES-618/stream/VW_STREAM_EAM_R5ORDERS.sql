CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_EAM_R5ORDERS
            AS
            SELECT
                ...
                src:"ORD_CODE"::varchar,
                src:"ORD_ORG"::varchar,
                src:"ORD_LASTSAVED"::datetime
                ,src,
                etl_load_datetime,
                etl_load_metadatafilename,
                ...
                src:"ORD_CODE"::varchar,
                src:"ORD_ORG"::varchar  ORDER BY 
                src:"ORD_LASTSAVED"::datetime desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
