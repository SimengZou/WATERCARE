CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_EAM_R5PPMS
            AS
            SELECT
                ...
                src:"PPM_CODE"::varchar,
                src:"PPM_REVISION"::numeric(38, 10),
                src:"PPM_LASTSAVED"::datetime
                ,src,
                etl_load_datetime,
                etl_load_metadatafilename,
                ...
                src:"PPM_CODE"::varchar,
                src:"PPM_REVISION"::numeric(38, 10)  ORDER BY 
                src:"PPM_LASTSAVED"::datetime desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
