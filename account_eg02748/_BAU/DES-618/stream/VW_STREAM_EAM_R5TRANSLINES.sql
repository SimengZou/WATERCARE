CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_EAM_R5TRANSLINES
            AS
            SELECT
                ...
                src:"TRL_LINE"::numeric(38, 10),
                src:"TRL_TRANS"::varchar,
                src:"TRL_LASTSAVED"::datetime
                ,src,
                etl_load_datetime,
                etl_load_metadatafilename,
                ...
                src:"TRL_LINE"::numeric(38, 10),
                src:"TRL_TRANS"::varchar  ORDER BY 
                src:"TRL_LASTSAVED"::datetime desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
