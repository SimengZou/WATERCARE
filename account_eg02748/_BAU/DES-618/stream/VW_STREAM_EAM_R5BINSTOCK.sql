CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_EAM_R5BINSTOCK
            AS
            SELECT
                ...
                src:"BIS_BIN"::varchar,
                src:"BIS_LOT"::varchar,
                src:"BIS_PART"::varchar,
                src:"BIS_PART_ORG"::varchar,
                src:"BIS_STORE"::varchar,
                src:"BIS_LASTSAVED"::datetime
                ,src,
                etl_load_datetime,
                etl_load_metadatafilename,
                ...
                src:"BIS_PART"::varchar,
                src:"BIS_PART_ORG"::varchar,
                src:"BIS_STORE"::varchar  ORDER BY 
                src:"BIS_LASTSAVED"::datetime desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
