                ...
                create or replace procedure DATAHUB_INTEGRATION.EAM_TARGET_MERGE_R5AUDVALUES()
              ...
              //  Start execution - log start
                ...
                snowflake.execute( {sqlText: "begin transaction;"} );
                  try
                      ...
                      var sql_command = `      
                                merge into  "DATAHUB_TARGET"."EAM_R5AUDVALUES" as target using (
                    ...
                    SELECT * FROM (SELECT
                     ...
                     FROM DATAHUB_INTEGRATION.VW_STREAM_EAM_R5AUDVALUES as  strm
                     )   
                WHERE ROWNUMBER=1  
                    ...
                    when matched then update set
                                target.AVA_ATTRIBUTE=src.AVA_ATTRIBUTE,
                                target.AVA_TABLE=src.AVA_TABLE,
                                target.AVA_PRIMARYID=src.AVA_PRIMARYID,
                                target.AVA_SECONDARYID=src.AVA_SECONDARYID,
                                target.AVA_FROM=src.AVA_FROM,
                                target.AVA_TO=src.AVA_TO,
                                target.AVA_CHANGED=src.AVA_CHANGED,
                                target.AVA_MODIFIEDBY=src.AVA_MODIFIEDBY,
                                target.AVA_FUNCTION=src.AVA_FUNCTION,
                                target.AVA_UPDATED=src.AVA_UPDATED,
                                target.AVA_INSERTED=src.AVA_INSERTED,
                                target.AVA_DELETED=src.AVA_DELETED,
                                target.AVA_UPDATECOUNT=src.AVA_UPDATECOUNT,
                                target.AVA_SCODE=src.AVA_SCODE,
                                target.AVA_MOBILE=src.AVA_MOBILE,
                                target.AVA_PRIMARYID2=src.AVA_PRIMARYID2,
                                target.AVA_LASTSAVED=src.AVA_LASTSAVED,
...
`
  merge into  "DATAHUB_TARGET_HISTORY"."EAM_DELETED_R5AUDVALUES" as target using (
