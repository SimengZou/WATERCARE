                ...
                create or replace procedure DATAHUB_INTEGRATION.EAM_TARGET_MERGE_U5REQADDRESOURCES()
              ...
              //  Start execution - log start
                ...
                snowflake.execute( {sqlText: "begin transaction;"} );
                  try
                      ...
                      var sql_command = `      
                                merge into  "DATAHUB_TARGET"."EAM_U5REQADDRESOURCES" as target using (
                    ...
                    SELECT * FROM (SELECT
                     ...
                     FROM DATAHUB_INTEGRATION.VW_STREAM_EAM_U5REQADDRESOURCES as  strm
                     )   
                WHERE ROWNUMBER=1  
                    ...
                    when matched then update set
                                target.RAR_TRANSID=src.RAR_TRANSID,
                                target.RAR_EVENT=src.RAR_EVENT,
                                target.RAR_TYPE=src.RAR_TYPE,
                                target.RAR_NOTES=src.RAR_NOTES,
                                target.RAR_HAZARDS=src.RAR_HAZARDS,
                                target.RAR_RESULTWONUM=src.RAR_RESULTWONUM,
                                target.RAR_RAISEDBY=src.RAR_RAISEDBY,
...
`
  merge into  "DATAHUB_TARGET_HISTORY"."EAM_DELETED_U5REQADDRESOURCES" as target using (
