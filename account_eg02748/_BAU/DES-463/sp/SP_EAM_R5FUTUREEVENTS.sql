                ...
                create or replace procedure DATAHUB_INTEGRATION.EAM_TARGET_MERGE_R5FUTUREEVENTS()
              ...
              //  Start execution - log start
                ...
                snowflake.execute( {sqlText: "begin transaction;"} );
                  try
                      ...
                      var sql_command = `      
                                merge into  "DATAHUB_TARGET"."EAM_R5FUTUREEVENTS" as target using (
...
`
  merge into  "DATAHUB_TARGET_HISTORY"."EAM_DELETED_R5FUTUREEVENTS" as target using (
