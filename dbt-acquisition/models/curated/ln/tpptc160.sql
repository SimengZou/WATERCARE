{{ config(
    ...
    description='LN tpptc160 Sundry Costs Budget Lines table, Generated 2026-04-10T19:42:23Z from package combination ce01101',
...
with cte_flattened as (
    select
        ...
        {{ trx_etl_columns() }}
    from {{ source('source_landing_ln', 'ln_tpptc160') }}
)
