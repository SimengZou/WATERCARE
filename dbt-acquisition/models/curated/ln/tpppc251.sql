{{ config(
    ...
    description='LN tpppc251 Equipment Costs table, Generated 2026-04-10T19:42:09Z from package combination ce01101',
...
with cte_flattened as (
    select
        ...
        {{ trx_json_extract('src', ['tetk'], type='int', alias='tetk') }},
        {{ trx_json_extract('src', ['tetk_kw'], type='varchar', alias='tetk_kw') }},
        ...
        {{ trx_etl_columns() }}
    from {{ source('source_landing_ln', 'ln_tpppc251') }}
)
