{{ config(
    ...
    description='LN tpptc230 Labor Budget Lines by Activity table, Generated 2026-04-10T19:42:24Z from package combination ce01101',
...
with cte_flattened as (
    select
        ...
        {{ trx_json_extract('src', ['prsr'], type='int', alias='prsr') }},
        {{ trx_json_extract('src', ['prsr_kw'], type='varchar', alias='prsr_kw') }},
        ...
        {{ trx_json_extract('src', ['cprj_cpla_cact_sero_ref_compnr'], type='int', alias='cprj_cpla_cact_sero_ref_compnr') }},
        ...
        {{ trx_etl_columns() }}
    from {{ source('source_landing_ln', 'ln_tpptc230') }}
)
