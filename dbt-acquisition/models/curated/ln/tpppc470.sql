{{ config(
    ...
    description='LN tpppc470 Cost Control by Project / Extension table, Generated 2026-04-10T19:42:17Z from package combination ce01101',
...
with cte_flattened as (
    select
        ...
        {{ trx_etl_columns() }}
    from {{ source('source_landing_ln', 'ln_tpppc470') }}
)
