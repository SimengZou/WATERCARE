{{ config(
    ...
    description='LN tpppc211 Material Costs table, Generated 2026-04-10T19:42:07Z from package combination ce01101',
...
with cte_flattened as (
    select
        ...
        {{ trx_json_extract('src', ['tetb'], type='int', alias='tetb') }},
        {{ trx_json_extract('src', ['tetb_kw'], type='varchar', alias='tetb_kw') }},
        ...
        {{ trx_etl_columns() }}
    from {{ source('source_landing_ln', 'ln_tpppc211') }}
)
