{{ config(
    ...
    description='LN tpptc150 Subcontracting Budget Lines table, Generated 2026-04-10T19:42:23Z from package combination ce01101',
...
with cte_flattened as (
    select
        ...
        {{ trx_etl_columns() }}
    from {{ source('source_landing_ln', 'ln_tpptc150') }}
)
