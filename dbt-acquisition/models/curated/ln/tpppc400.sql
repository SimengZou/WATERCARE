{{ config(
    ...
    description='LN tpppc400 Cost Control by Project table, Generated 2026-04-10T19:42:12Z from package combination ce01101',
...
with cte_flattened as (
    select
        ...
        {{ trx_json_extract('src', ['amfc_1'], type='float', alias='amfc_1') }},
        {{ trx_json_extract('src', ['amfc_2'], type='float', alias='amfc_2') }},
        {{ trx_json_extract('src', ['amfc_3'], type='float', alias='amfc_3') }},
        {{ trx_json_extract('src', ['amfc_4'], type='float', alias='amfc_4') }},
        {{ trx_json_extract('src', ['amfr_1'], type='float', alias='amfr_1') }},
        {{ trx_json_extract('src', ['amfr_2'], type='float', alias='amfr_2') }},
        {{ trx_json_extract('src', ['amfr_3'], type='float', alias='amfr_3') }},
        {{ trx_json_extract('src', ['amfr_4'], type='float', alias='amfr_4') }},
        ...
        {{ trx_json_extract('src', ['ambp_1'], type='float', alias='ambp_1') }},
        {{ trx_json_extract('src', ['ambp_2'], type='float', alias='ambp_2') }},
        {{ trx_json_extract('src', ['ambp_3'], type='float', alias='ambp_3') }},
        {{ trx_json_extract('src', ['ambp_4'], type='float', alias='ambp_4') }},
        {{ trx_json_extract('src', ['ambr_1'], type='float', alias='ambr_1') }},
        {{ trx_json_extract('src', ['ambr_2'], type='float', alias='ambr_2') }},
        {{ trx_json_extract('src', ['ambr_3'], type='float', alias='ambr_3') }},
        {{ trx_json_extract('src', ['ambr_4'], type='float', alias='ambr_4') }},
        {{ trx_json_extract('src', ['amds_1'], type='float', alias='amds_1') }},
        {{ trx_json_extract('src', ['amds_2'], type='float', alias='amds_2') }},
        {{ trx_json_extract('src', ['amds_3'], type='float', alias='amds_3') }},
        {{ trx_json_extract('src', ['amds_4'], type='float', alias='amds_4') }},
        {{ trx_json_extract('src', ['amdr_1'], type='float', alias='amdr_1') }},
        {{ trx_json_extract('src', ['amdr_2'], type='float', alias='amdr_2') }},
        {{ trx_json_extract('src', ['amdr_3'], type='float', alias='amdr_3') }},
        {{ trx_json_extract('src', ['amdr_4'], type='float', alias='amdr_4') }},
        ...
        {{ trx_etl_columns() }}
    from {{ source('source_landing_ln', 'ln_tpppc400') }}
)

select
    *,
    {{ trx_audit_columns() }},
    {{ trx_audit_surrogate(columns=['compnr', 'cprj', 'mpto']) }}
from cte_flattened
{% if is_incremental() %}
