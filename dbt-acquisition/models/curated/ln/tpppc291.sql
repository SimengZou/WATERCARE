{{ config(
    ...
    description='LN tpppc291 Sundry Costs table, Generated 2026-04-10T19:42:11Z from package combination ce01101',
...
with cte_flattened as (
    select
        ...
        {{ trx_json_extract('src', ['teti'], type='int', alias='teti') }},
        {{ trx_json_extract('src', ['teti_kw'], type='varchar', alias='teti_kw') }},
        ...
        {{ trx_json_extract('src', ['hemn'], type='varchar', alias='hemn') }},
        {{ trx_json_extract('src', ['hsrn'], type='int', alias='hsrn') }},
        ...
        {{ trx_json_extract('src', ['hemn_ref_compnr'], type='int', alias='hemn_ref_compnr') }},
        ...
        {{ trx_etl_columns() }}
    from {{ source('source_landing_ln', 'ln_tpppc291') }}
)

select
    *,
    {{ trx_audit_columns() }},
    {{ trx_audit_surrogate(columns=['compnr', 'cprj', 'cico', 'sern']) }}
from cte_flattened
{% if is_incremental() %}
