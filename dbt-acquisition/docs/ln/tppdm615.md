...
LN tppdm615 Project Labor table, Generated 2026-04-10T19:42:00Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tppdm615` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `task` |
| **Column count** | 70 |
...
| `dfts` | `string` | `varchar` |  |  | Derived from. Max length: 8 |
...
| `dfrc` | `integer` | `int` |  |  | Final Labor Rate. Allowed values: 1, 2 |
| `dfrc_kw` | `string` | `varchar` |  |  | Final Labor Rate (keyword). Allowed values: tppdm.yeno.yes, tppdm.yeno.no |
...
| `dfrs` | `integer` | `int` |  |  | Final Sales Rate. Allowed values: 1, 2 |
| `dfrs_kw` | `string` | `varchar` |  |  | Final Sales Rate (keyword). Allowed values: tppdm.yeno.yes, tppdm.yeno.no |
...
| `dfri` | `integer` | `int` |  |  | Final Intercompany Rate. Allowed values: 1, 2 |
| `dfri_kw` | `string` | `varchar` |  |  | Final Intercompany Rate (keyword). Allowed values: tppdm.yeno.yes, tppdm.yeno.no |
...
| `dfts_ref_compnr` | `integer` | `int` |  |  | company number of primary key of table tppdm015 Labor |
...
| `cprj_ccts` | `string` | `varchar` |  |  | CC: Project Control Code Labor. Max length: 25 |
