...
LN tppss202 Activity History table, Generated 2026-04-10T19:42:19Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tppss202` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `cpla`, `cact`, `hdat` |
| **Column count** | 163 |
...
| `hdat` | `timestamp` | `timestamp_ntz` | `PK` | `not_null` | (required) Modified on |
| `hsts` | `integer` | `int` |  |  | History Status. Allowed values: 10, 20, 30 |
| `hsts_kw` | `string` | `varchar` |  |  | History Status (keyword). Allowed values: tpctm.hist.created, tpctm.hist.modified, tpctm.hist.deleted |
| `husr` | `string` | `varchar` |  |  | Modified by. Max length: 16 |
...
| `rent` | `integer` | `int` |  |  | Equipment Rental. Allowed values: 1, 2 |
| `rent_kw` | `string` | `varchar` |  |  | Equipment Rental (keyword). Allowed values: tcyesno.yes, tcyesno.no |
