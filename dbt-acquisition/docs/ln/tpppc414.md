...
LN tpppc414 Cost Control by Project / Sundry Cost Control Code table, Generated 2026-04-10T19:42:14Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc414` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `ccic` |
| **Column count** | 53 |
