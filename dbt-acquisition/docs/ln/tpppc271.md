...
LN tpppc271 Subcontracting Costs table, Generated 2026-04-10T19:42:10Z from package combination ce01101
...
| `tetf` | `integer` | `int` |  |  | Posting Type. Allowed values: 1, 2, 3, 4, 5, 6, 7 |
| `tetf_kw` | `string` | `varchar` |  |  | Posting Type (keyword). Allowed values: tpppc.tetf.manu, tpppc.tetf.invoice, tpppc.tetf.order.invoice, tpppc.tetf.invoice.diff, tpppc.tetf.exp.tax.dir, tpppc.tetf.value.corr.rev, tpppc.tetf.service |
