...
LN whina112 Inventory Receipt Transactions table, Generated 2026-04-10T19:42:43Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_whina112` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `item`, `cwar`, `trdt`, `seqn`, `inwp` |
| **Column count** | 54 |
...
| `qstk` | `float` | `float` |  |  | Received Quantity |
| `qskt` | `float` | `float` |  |  | Quantity To be Consumed |
...
| `vaco` | `integer` | `int` |  |  | Revaluation Assigned or Inventory Variance Assigned. Allowed values: 1, 2 |
| `vaco_kw` | `string` | `varchar` |  |  | Revaluation Assigned or Inventory Variance Assigned (keyword). Allowed values: tcyesno.yes, tcyesno.no |
...
| `qaiu` | `float` | `float` |  |  | Attribute Set Inventory After Transaction |
