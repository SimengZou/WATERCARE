...
LN tcmcs143 States/Provinces table, Generated 2026-04-10T19:41:15Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tcmcs143` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `ccty`, `cste` |
| **Column count** | 17 |
...
| `abbr` | `string` | `varchar` |  |  | Abbreviation. Max length: 6 |
