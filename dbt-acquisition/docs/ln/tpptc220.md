...
LN tpptc220 Material Budget Lines by Activity table, Generated 2026-04-10T19:42:24Z from package combination ce01101
...
| `snsb` | `integer` | `int` |  |  | Sequence Number Material Line in Element Budget |
| `copy` | `integer` | `int` |  |  | Item Line Copied. Allowed values: 1, 2 |
| `copy_kw` | `string` | `varchar` |  |  | Item Line Copied (keyword). Allowed values: tppdm.yeno.yes, tppdm.yeno.no |
