...
LN tppdm035 Subcontracting table, Generated 2026-04-10T19:41:55Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tppdm035` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `csub` |
| **Column count** | 104 |
...
| `cdf_sctg__en_us` | `string` | `varchar` |  | `not_null` | (required) Sub Category - base language. Max length: 30 |
