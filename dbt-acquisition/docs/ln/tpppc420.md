...
LN tpppc420 Cost Control by Project / Element table, Generated 2026-04-10T19:42:14Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc420` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `mpto`, `cspa` |
| **Column count** | 60 |
