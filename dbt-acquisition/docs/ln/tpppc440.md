...
LN tpppc440 Cost Control by Project / Activity table, Generated 2026-04-10T19:42:15Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc440` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `mpto`, `cpla`, `cact` |
| **Column count** | 61 |
