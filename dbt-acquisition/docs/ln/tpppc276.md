...
LN tpppc276 Subcontracting Cost Forecast table, Generated 2026-04-10T19:42:10Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc276` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `rgdt`, `csub`, `cspa`, `cact` |
| **Column count** | 72 |
...
| `pric_prjc` | `float` | `float` |  |  | CC: Subcontracting Cost Price in Project Currency |
| `amoc_prjc` | `float` | `float` |  |  | CC: Subcontracting Cost Amount in Project Currency |
| `pric_cntc` | `float` | `float` |  |  | CC: Subcontracting Cost Price in Contract Currency |
| `amoc_cntc` | `float` | `float` |  |  | CC: Subcontracting Cost Amount in Contract Currency |
| `pric_dwhc` | `float` | `float` |  |  | CC: Subcontracting Cost Price in Data Warehouse Currency |
| `amoc_dwhc` | `float` | `float` |  |  | CC: Subcontracting Cost Amount in Data Warehouse Currency |
| `pric_refc` | `float` | `float` |  |  | CC: Subcontracting Cost Price in Reference Currency |
| `amoc_refc` | `float` | `float` |  |  | CC: Subcontracting Cost Amount in Reference Currency |
| `pric_homc` | `float` | `float` |  |  | CC: Subcontracting Cost Price in Local Currency |
| `pric_rpc1` | `float` | `float` |  |  | CC: Subcontracting Cost Price in Reference Currency 1 |
| `pric_rpc2` | `float` | `float` |  |  | CC: Subcontracting Cost Price in Reference Currency 2 |
| `amoc_homc` | `float` | `float` |  |  | CC: Subcontracting Cost Amount in Local Currency |
| `amoc_rpc1` | `float` | `float` |  |  | CC: Subcontracting Cost Amount in Reporting Currency 1 |
| `amoc_rpc2` | `float` | `float` |  |  | CC: Subcontracting Cost Amount in Reporting Currency 2 |
...
| `csub_rcmp` | `integer` | `int` |  |  | CC: Reference Company of Subcontracing |
