...
LN tccom121 Ship-from Business Partners table, Generated 2026-04-10T19:41:03Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tccom121` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `sfbp` |
| **Column count** | 67 |
...
| `sfbp` | `string` | `varchar` | `PK` | `not_null` | (required) Ship-from Business Partner. Max length: 9 |
...
| `sasn` | `integer` | `int` |  |  | Business Partner sends ASN. Allowed values: 1, 2 |
| `sasn_kw` | `string` | `varchar` |  |  | Business Partner sends ASN (keyword). Allowed values: tcyesno.yes, tcyesno.no |
