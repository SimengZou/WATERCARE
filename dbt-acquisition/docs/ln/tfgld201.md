...
LN tfgld201 History - Ledger Account Totals table, Generated 2026-04-10T19:41:43Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tfgld201` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cono`, `ptyp`, `year`, `prno`, `leac`, `ccur`, `duac`, `bpid` |
| **Column count** | 41 |
