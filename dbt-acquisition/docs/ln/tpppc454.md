...
LN tpppc454 Cost Control by Project / Activity / Sundry Cost Control Code table, Generated 2026-04-10T19:42:16Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc454` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `cpla`, `cact`, `ccic` |
| **Column count** | 56 |
