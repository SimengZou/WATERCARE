...
LN tpppc413 Cost Control by Project / Subcontracting Control Code table, Generated 2026-04-10T19:42:14Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc413` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `ccsb` |
| **Column count** | 53 |
