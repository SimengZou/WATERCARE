...
LN tpppc451 Cost Control by Project / Activity / Labor Control Code table, Generated 2026-04-10T19:42:16Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc451` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `cpla`, `cact`, `ccts` |
| **Column count** | 56 |
