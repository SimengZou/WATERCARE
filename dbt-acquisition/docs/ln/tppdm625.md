...
LN tppdm625 Project Equipment table, Generated 2026-04-10T19:42:00Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tppdm625` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `cequ` |
| **Column count** | 140 |
...
| `dfeq` | `string` | `varchar` |  |  | Derived from. Max length: 47 |
...
| `dfrp` | `integer` | `int` |  |  | Final Purchase Rate. Allowed values: 1, 2 |
| `dfrp_kw` | `string` | `varchar` |  |  | Final Purchase Rate (keyword). Allowed values: tppdm.yeno.yes, tppdm.yeno.no |
...
| `dfeq_ref_compnr` | `integer` | `int` |  |  | company number of primary key of table tppdm025 Equipment |
