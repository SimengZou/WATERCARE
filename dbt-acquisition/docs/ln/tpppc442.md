...
LN tpppc442 Cost Control by Project / Activity / Cost Component table, Generated 2026-04-10T19:42:15Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc442` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `mpto`, `cpla`, `cact`, `ccco` |
| **Column count** | 71 |
