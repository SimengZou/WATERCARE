...
LN tpppc453 Cost Control by Project / Activity / Subcontracting Control Code table, Generated 2026-04-10T19:42:16Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc453` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `cpla`, `cact`, `ccsb` |
| **Column count** | 56 |
...
| `ccsb` | `string` | `varchar` | `PK` | `not_null` | (required) Control Code Subcontracting. Max length: 47 |
...
| `qupe` | `float` | `float` |  |  | Qty Commitments this Period |
