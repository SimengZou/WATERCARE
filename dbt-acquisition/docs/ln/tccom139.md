...
LN tccom139 Cities by Country table, Generated 2026-04-10T19:41:04Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tccom139` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `ccty`, `cste`, `city` |
| **Column count** | 18 |
...
| `cste` | `string` | `varchar` | `PK` | `not_null` | (required) State/Province. Max length: 3 |
| `city` | `string` | `varchar` | `PK` | `not_null` | (required) City. Max length: 8 |
