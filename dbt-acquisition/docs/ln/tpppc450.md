...
LN tpppc450 Cost Control by Project / Activity / Material Control Code table, Generated 2026-04-10T19:42:16Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc450` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `cpla`, `cact`, `ccit` |
| **Column count** | 57 |
