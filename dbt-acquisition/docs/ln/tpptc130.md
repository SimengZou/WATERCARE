...
LN tpptc130 Labor Budget Lines table, Generated 2026-04-10T19:42:21Z from package combination ce01101
...
| `sero` | `integer` | `int` |  |  | Seq. No. Subcontracting Line |
...
| `dfrc` | `integer` | `int` |  |  | Final Labor Rate. Allowed values: 0, 1, 2 |
...
| `cprj_cspa_sero_ref_compnr` | `integer` | `int` |  |  | company number of primary key of table tpptc150 Subcontracting Budget Lines |
