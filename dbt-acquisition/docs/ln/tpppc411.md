...
LN tpppc411 Cost Control by Project / Labor Control Code table, Generated 2026-04-10T19:42:14Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc411` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `ccts` |
| **Column count** | 53 |
