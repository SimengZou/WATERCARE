...
LN tpptc315 Actual Budget by Activity/Cost Type table, Generated 2026-04-10T19:42:26Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpptc315` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `ccal`, `cpla`, `cact` |
| **Column count** | 43 |
...
| `aicc_1` | `float` | `float` |  |  | Surcharge Amount |
| `aicc_2` | `float` | `float` |  |  | Surcharge Amount |
| `aicc_3` | `float` | `float` |  |  | Surcharge Amount |
| `aicc_4` | `float` | `float` |  |  | Surcharge Amount |
