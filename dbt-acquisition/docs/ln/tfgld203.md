...
LN tfgld203 Opening Balances - Ledger/Currency table, Generated 2026-04-10T19:41:44Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tfgld203` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cono`, `year`, `leac`, `ccur`, `duac`, `bpid` |
| **Column count** | 30 |
