...
LN ttdpm515 Tables to Publish table, Generated 2026-04-10T19:42:40Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_ttdpm515` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `pacc`, `dset`, `cpac`, `cmod`, `flno` |
| **Column count** | 21 |
...
| `cpac` | `string` | `varchar` | `PK` | `not_null` | (required) Package. Max length: 2 |
| `cmod` | `string` | `varchar` | `PK` | `not_null` | (required) Module. Max length: 3 |
| `flno` | `string` | `varchar` | `PK` | `not_null` | (required) Table. Max length: 3 |
