...
LN tpppc296 Sundry Cost Forecast table, Generated 2026-04-10T19:42:11Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc296` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `rgdt`, `cico`, `cspa`, `cact` |
| **Column count** | 71 |
...
| `pric_prjc` | `float` | `float` |  |  | CC: Sundry Cost Price in Project Currency |
| `amoc_prjc` | `float` | `float` |  |  | CC: Sundry Cost Amount in Project Currency |
| `pric_cntc` | `float` | `float` |  |  | CC: Sundry Cost Price in Contract Currency |
| `amoc_cntc` | `float` | `float` |  |  | CC: Sundry Cost Amount in Contract Currency |
| `pric_dwhc` | `float` | `float` |  |  | CC: Sundry Cost Price in Data Warehouse Currency |
| `amoc_dwhc` | `float` | `float` |  |  | CC: Sundry Cost Amount in Data Warehouse Currency |
| `pric_refc` | `float` | `float` |  |  | CC: Sundry Cost Price in Reference Currency |
| `amoc_refc` | `float` | `float` |  |  | CC: Sundry Cost Amount in Reference Currency |
| `pric_homc` | `float` | `float` |  |  | CC: Sundry Cost Price in Local Currency |
| `pric_rpc1` | `float` | `float` |  |  | CC: Sundry Cost Price in Reporting Currency 1 |
| `pric_rpc2` | `float` | `float` |  |  | CC: Sundry Cost Price in Reporting Currency 2 |
| `amoc_homc` | `float` | `float` |  |  | CC: Sundry Cost Amount in Local Currency |
| `amoc_rpc1` | `float` | `float` |  |  | CC: Sundry Cost Amount in Reporting Currency 1 |
| `amoc_rpc2` | `float` | `float` |  |  | CC: Sundry Cost Amount in Reporting Currency 2 |
