...
LN whinr120 Item Issue by Period table, Generated 2025-06-12T01:48:43Z from package combination ce01090
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_whinr120` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `item`, `year`, `peri` |
| **Column count** | 23 |
...
| `ddcl` | `float` | `float` |  |  | Demand Direct Delivery Calls |
| `ddqt` | `float` | `float` |  |  | Demand Direct Delivery Quantity |
