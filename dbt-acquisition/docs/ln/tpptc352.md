...
LN tpptc352 Actual Budget by Equipment Control Code table, Generated 2026-04-10T19:42:27Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpptc352` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `ccal`, `cceq` |
| **Column count** | 21 |
...
| `cceq` | `string` | `varchar` | `PK` | `not_null` | (required) Control Code Equipment. Max length: 47 |
| `amoc_1` | `float` | `float` |  |  | Amount |
| `amoc_2` | `float` | `float` |  |  | Amount |
| `amoc_3` | `float` | `float` |  |  | Amount |
| `amoc_4` | `float` | `float` |  |  | Amount |
| `quan` | `float` | `float` |  |  | Amount of Time |
