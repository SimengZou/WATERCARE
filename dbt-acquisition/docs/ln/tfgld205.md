...
LN tfgld205 History - Dimension/Ledger Account Combination Totals table, Generated 2026-04-10T19:41:44Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tfgld205` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cono`, `ptyp`, `year`, `prno`, `dim1`, `dim2`, `dim3`, `dim4`, `dim5`, `dims`, `leac`, `ccur`, `duac`, `bpid` |
| **Column count** | 65 |
...
| `fdah_rfrc` | `float` | `float` |  |  | CC: Finalized Debit Amount in Reference Currency |
| `fdah_dtwc` | `float` | `float` |  |  | CC: Finalized Debit Amount in Data Warehouse Currency |
| `fcah_rfrc` | `float` | `float` |  |  | CC: Finalized Credit Amount in Reference Currency |
| `fcah_dtwc` | `float` | `float` |  |  | CC: Finalized Credit Amount in Data Warehouse Currency |
| `ndah_rfrc` | `float` | `float` |  |  | CC: Not Finalized Debit Amount in Reference Currency |
| `ndah_dtwc` | `float` | `float` |  |  | CC: Not Finalized Debit Amount in Data Warehouse Currency |
| `ncah_rfrc` | `float` | `float` |  |  | CC: Not Finalized Credit Amount in Reference Currency |
| `ncah_dtwc` | `float` | `float` |  |  | CC: Not Finalized Credit Amount in Data Warehouse Currency |
| `dimx_sgm1` | `string` | `varchar` |  |  | CC: History Dimension Segment 1. Max length: 9 |
| `dimx_sgm2` | `string` | `varchar` |  |  | CC: History Dimension Segment 2. Max length: 9 |
