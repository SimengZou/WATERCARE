...
LN tpptc350 Actual Budget by Material Control Code table, Generated 2026-04-10T19:42:26Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpptc350` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `ccal`, `ccit` |
| **Column count** | 21 |
...
| `ccit_ref_compnr` | `integer` | `int` |  |  | company number of primary key of table tppdm005 Item Project Data |
