...
LN tpppc402 Cost Control by Project / Cost Component table, Generated 2026-04-10T19:42:13Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc402` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `mpto`, `ccco`, `cott` |
| **Column count** | 72 |
...
| `cott` | `integer` | `int` | `PK` | `not_null` | (required) Cost Type. Allowed values: 1, 2, 3, 4, 5, 6, 7, 10 |
| `cott_kw` | `string` | `varchar` |  |  | Cost Type (keyword). Allowed values: tppdm.cott.tasks, tppdm.cott.materials, tppdm.cott.equipment, tppdm.cott.subcontracting, tppdm.cott.indirect, tppdm.cott.total, tppdm.cott.ptotal, tppdm.cott.overhead |
