...
LN whina115 Inventory Receipt Transaction Consumptions Cost Details table, Generated 2026-04-10T19:42:44Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_whina115` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `item`, `cwar`, `trdt`, `seqn`, `inwp`, `sern`, `cpcp` |
| **Column count** | 26 |
...
| `item_cwar_trdt_seqn_inwp_sern_ref_compnr` | `integer` | `int` |  |  | company number of primary key of table whina114 Inventory Receipt Transaction Consumptions |
