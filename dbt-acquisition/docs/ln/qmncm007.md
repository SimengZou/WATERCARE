...
LN qmncm007 Material Dispositions table, Generated 2022-06-15T01:21:01Z from package combination ce01055
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_qmncm007` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `mdis` |
| **Column count** | 16 |
...
| `mdis` | `string` | `varchar` | `PK` | `not_null` | (required) Code. Max length: 9 |
| `dsca__en_us` | `string` | `varchar` |  | `not_null` | (required) Material Non-Conformance Disposition - base language. Max length: 30 |
