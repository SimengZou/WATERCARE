...
LN tcppl040 Teams table, Generated 2026-04-10T19:41:16Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tcppl040` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cgrp` |
| **Column count** | 22 |
...
| `cgrp` | `string` | `varchar` | `PK` | `not_null` | (required) Teams. Max length: 9 |
...
| `wtsc` | `string` | `varchar` |  |  | Working Time Schedule Code. Max length: 3 |
| `spvr` | `string` | `varchar` |  |  | Supervisor. Max length: 9 |
...
| `spvr_ref_compnr` | `integer` | `int` |  |  | company number of primary key of table tccom001 Employees - General |
