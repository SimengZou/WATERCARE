...
LN tppdm643 Project Revenues table, Generated 2026-04-10T19:42:01Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tppdm643` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `cpro` |
| **Column count** | 19 |
