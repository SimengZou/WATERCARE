...
LN tpppc231 Labor Costs table, Generated 2026-04-10T19:42:08Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc231` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cpth`, `year`, `peri`, `emno`, `sern` |
| **Column count** | 112 |
...
| `cpth` | `string` | `varchar` | `PK` | `not_null` | (required) Cost Period Table for Cost Control Period. Max length: 6 |
...
| `tetc` | `integer` | `int` |  |  | Posting Type. Allowed values: 1, 2, 3, 4, 5 |
| `tetc_kw` | `string` | `varchar` |  |  | Posting Type (keyword). Allowed values: tpppc.tetc.manu, tpppc.tetc.central, tpppc.tetc.expense, tpppc.tetc.service, tpppc.tetc.invoice |
...
| `serc` | `integer` | `int` |  |  | Hours Accounting Sequence |
| `serh` | `integer` | `int` |  |  | History Sequence.No. |
...
| `cdf_quan` | `float` | `float` |  |  | EAM No. of Hours |
