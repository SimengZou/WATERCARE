...
LN tpptc353 Actual Budget by Subcontracting Control Code table, Generated 2026-04-10T19:42:27Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpptc353` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `ccal`, `ccsb` |
| **Column count** | 20 |
