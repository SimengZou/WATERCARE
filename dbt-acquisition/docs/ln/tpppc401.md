...
LN tpppc401 Cost Control by Project / Cost Type table, Generated 2026-04-10T19:42:13Z from package combination ce01101
...
|---|---|
| **Source system** | `ln` |
| **Source table** | `ln_tpppc401` |
| **Materialization** | `incremental` |
| **Primary keys** | `compnr`, `cprj`, `mpto`, `cotp` |
| **Column count** | 58 |
