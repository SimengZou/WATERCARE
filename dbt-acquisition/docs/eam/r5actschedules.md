...
|---|---|
| **Source system** | `eam` |
| **Source table** | `eam_r5actschedules` |
| **Materialization** | `incremental` |
| **Primary keys** | `acs_code` |
| **Column count** | 27 |
...
| `acs_starttime` | `float` | `float` |  |  | ACS_STARTTIME |
| `acs_endtime` | `float` | `float` |  |  | ACS_ENDTIME |
...
| `acs_code` | `string` | `varchar` | `PK` | `unique` | ACS_CODE |
| `acs_updated` | `timestamp` | `timestamp_ntz` |  |  | ACS_UPDATED |
| `acs_shiftschedulesession` | `float` | `float` |  |  | ACS_SHIFTSCHEDULESESSION |
