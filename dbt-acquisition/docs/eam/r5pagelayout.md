...
|---|---|
| **Source system** | `eam` |
| **Source table** | `eam_r5pagelayout` |
| **Materialization** | `incremental` |
| **Primary keys** | `plo_usergroup`, `plo_pagename`, `plo_elementid`, `plo_meflag` |
| **Column count** | 25 |
...
| `plo_elementid` | `string` | `varchar` | `PK` |  | PLO_ELEMENTID |
...
| `plo_meflag` | `string` | `varchar` | `PK` |  | PLO_MEFLAG |
| `plo_defaultvalue` | `string` | `varchar` |  |  | PLO_DEFAULTVALUE |
| `plo_parentpage` | `string` | `varchar` |  |  | PLO_PARENTPAGE |
| `plo_usergroup` | `string` | `varchar` | `PK` |  | PLO_USERGROUP |
| `plo_pagename` | `string` | `varchar` | `PK` |  | PLO_PAGENAME |
