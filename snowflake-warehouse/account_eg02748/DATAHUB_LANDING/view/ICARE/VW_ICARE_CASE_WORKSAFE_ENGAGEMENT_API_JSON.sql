create or replace view VW_ICARE_CASE_WORKSAFE_ENGAGEMENT_API_JSON as 
...
value:worksafe_contact_type::varchar as "WORKSAFE_CONTACT_TYPE",
...
value:reference_number::varchar as "REFERENCE_NUMBER",
...
value:worksafe_description::varchar as "WORKSAFE_DESCRIPTION",
...
value:other_contact_type::varchar as "OTHER_CONTACT_TYPE",
...
--,SYSDATE() as ETL_LOAD_DATETIME
  ...
  from
    ...
    DATAHUB_LANDING.ICARE_CASE_WORKSAFE_ENGAGEMENT_API 
