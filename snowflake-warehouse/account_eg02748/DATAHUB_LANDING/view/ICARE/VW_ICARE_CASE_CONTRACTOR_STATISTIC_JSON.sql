create or replace view VW_ICARE_CASE_CONTRACTOR_STATISTIC_JSON as 
...
value:corrective_actions_raised_count::varchar as "CORRECTIVE_ACTIONS_RAISED_COUNT",

value:skills::varchar as "SKILLS",

value:number::varchar as "NUMBER",

value:report_start_date::varchar as "REPORT_START_DATE",
...
value:lti_count::varchar as "LTI_COUNT",
...
value:new_hazard_count::varchar as "NEW_HAZARD_COUNT",

value:safety_conversation_count::varchar as "SAFETY_CONVERSATION_COUNT",

value:fai_count::varchar as "FAI_COUNT",
...
value:mti_count::varchar as "MTI_COUNT",
...
value:property_damage_count::varchar as "PROPERTY_DAMAGE_COUNT",

value:sys_updated_by::varchar as "SYS_UPDATED_BY",

value:opened_by::varchar as "OPENED_BY",

value:project_id::varchar as "PROJECT_ID",
...
value:other_contractor::varchar as "OTHER_CONTRACTOR",
...
value:corrective_actions_completed_count::varchar as "CORRECTIVE_ACTIONS_COMPLETED_COUNT",

TRY_TO_TIMESTAMP_NTZ(value:work_end::varchar) as "WORK_END",

value:close_call_count::varchar as "CLOSE_CALL_COUNT",

value:assignment_group::varchar as "ASSIGNMENT_GROUP",

value:inspection_count::varchar as "INSPECTION_COUNT",
...
value:audit_count::varchar as "AUDIT_COUNT",
...
value:report_end_date::varchar as "REPORT_END_DATE",
...
value:rdi_count::varchar as "RDI_COUNT",
...
--,SYSDATE() as ETL_LOAD_DATETIME
  ...
  from
    ...
    DATAHUB_LANDING.ICARE_CASE_CONTRACTOR_STATISTIC
