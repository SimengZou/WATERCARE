create or replace view VW_ICARE_INCIDENT_API_JSON as 

select

value:parent::varchar as "PARENT",

value:environmental_damage::varchar as "ENVIRONMENTAL_DAMAGE",
...
value:equipment_used::varchar as "EQUIPMENT_USED",

value:skills::varchar as "SKILLS",

value:number::varchar as "NUMBER",

value:head_injury::varchar as "HEAD_INJURY",
...
value:entire_body_injury::varchar as "ENTIRE_BODY_INJURY",

value:injury_category::varchar as "INJURY_CATEGORY",
...
value:illness_count::varchar as "ILLNESS_COUNT",
...
value:injury_or_illness::varchar as "INJURY_OR_ILLNESS",
...
value:what_happened::varchar as "WHAT_HAPPENED",

TRY_TO_NUMBER(value:calendar_duration::varchar) as "CALENDAR_DURATION",

value:tell_us_about_it::varchar as "TELL_US_ABOUT_IT",
...
--,SYSDATE() as ETL_LOAD_DATETIME
  ...
  from
    ...
    DATAHUB_LANDING.ICARE_INCIDENT_API 
