create or replace view VW_ICARE_ALL_ICARE_ACTIONS_API_JSON
 as 
...
value:sys_created_on::TIMESTAMP_NTZ  as "SYS_CREATED_ON",
...
value:action_type::varchar as "ACTION_TYPE",
...
--,SYSDATE() as ETL_LOAD_DATETIME
  ...
  from
    ...
    DATAHUB_LANDING.ICARE_ALL_ICARE_ACTIONS_API
