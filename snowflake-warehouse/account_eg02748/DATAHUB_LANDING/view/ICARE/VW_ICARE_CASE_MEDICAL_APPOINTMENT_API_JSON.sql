create or replace view VW_ICARE_CASE_MEDICAL_APPOINTMENT_API_JSON as 
...
value:appointment_type::varchar as "APPOINTMENT_TYPE",
...
value:best_location::varchar as "BEST_LOCATION",
...
--,SYSDATE() as ETL_LOAD_DATETIME
  ...
  from
    ...
    DATAHUB_LANDING.ICARE_CASE_MEDICAL_APPOINTMENT_API 
