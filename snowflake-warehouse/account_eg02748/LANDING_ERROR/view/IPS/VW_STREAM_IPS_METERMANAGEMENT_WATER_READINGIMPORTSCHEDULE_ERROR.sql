CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_METERMANAGEMENT_WATER_READINGIMPORTSCHEDULE_ERROR AS SELECT src, 'IPS_METERMANAGEMENT_WATER_READINGIMPORTSCHEDULE' as TABLE_OBJECT, CASE WHEN 
