CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_BILLING_ACCOUNTDIRECTDEBIT_ERROR AS SELECT src, 'IPS_BILLING_ACCOUNTDIRECTDEBIT' as TABLE_OBJECT, CASE WHEN 
