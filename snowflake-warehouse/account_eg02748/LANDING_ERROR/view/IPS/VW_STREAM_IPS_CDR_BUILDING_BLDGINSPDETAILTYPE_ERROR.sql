CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_BUILDING_BLDGINSPDETAILTYPE_ERROR AS SELECT src, 'IPS_CDR_BUILDING_BLDGINSPDETAILTYPE' as TABLE_OBJECT, CASE WHEN 
