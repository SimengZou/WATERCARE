CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_PLANNING_PLANCODEVIOL_ERROR AS SELECT src, 'IPS_CDR_PLANNING_PLANCODEVIOL' as TABLE_OBJECT, CASE WHEN 
