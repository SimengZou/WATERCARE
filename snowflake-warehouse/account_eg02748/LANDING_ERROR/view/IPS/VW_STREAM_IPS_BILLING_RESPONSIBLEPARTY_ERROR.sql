CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_BILLING_RESPONSIBLEPARTY_ERROR AS SELECT src, 'IPS_BILLING_RESPONSIBLEPARTY' as TABLE_OBJECT, CASE WHEN 
