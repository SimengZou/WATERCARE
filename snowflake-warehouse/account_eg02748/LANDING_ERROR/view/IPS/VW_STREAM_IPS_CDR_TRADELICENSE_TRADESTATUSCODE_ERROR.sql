CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_TRADELICENSE_TRADESTATUSCODE_ERROR AS SELECT src, 'IPS_CDR_TRADELICENSE_TRADESTATUSCODE' as TABLE_OBJECT, CASE WHEN 
