CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_ASSETMANAGEMENT_STORM_COMPSTSL_ERROR AS SELECT src, 'IPS_ASSETMANAGEMENT_STORM_COMPSTSL' as TABLE_OBJECT, CASE WHEN 
