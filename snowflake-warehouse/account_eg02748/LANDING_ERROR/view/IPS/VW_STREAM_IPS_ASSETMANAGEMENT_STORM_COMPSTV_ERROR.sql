CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_ASSETMANAGEMENT_STORM_COMPSTV_ERROR AS SELECT src, 'IPS_ASSETMANAGEMENT_STORM_COMPSTV' as TABLE_OBJECT, CASE WHEN 
