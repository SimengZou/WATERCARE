CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_WSLASSETWATER_XSRRETAILAUDITMETERDP_ERROR AS SELECT src, 'IPS_WSLASSETWATER_XSRRETAILAUDITMETERDP' as TABLE_OBJECT, CASE WHEN 
