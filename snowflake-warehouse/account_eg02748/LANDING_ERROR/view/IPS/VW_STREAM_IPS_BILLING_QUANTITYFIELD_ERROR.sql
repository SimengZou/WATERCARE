CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_BILLING_QUANTITYFIELD_ERROR AS SELECT src, 'IPS_BILLING_QUANTITYFIELD' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:PROMPTTYPE), '0'), 38, 10) is null and 
                    src:PROMPTTYPE is not null) THEN
                    'PROMPTTYPE contains a non-numeric value : \'' || AS_VARCHAR(src:PROMPTTYPE) || '\'' WHEN 
