CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_PLANNING_PLANNINGSTATUSCODE_ERROR AS SELECT src, 'IPS_CDR_PLANNING_PLANNINGSTATUSCODE' as TABLE_OBJECT, CASE WHEN 
