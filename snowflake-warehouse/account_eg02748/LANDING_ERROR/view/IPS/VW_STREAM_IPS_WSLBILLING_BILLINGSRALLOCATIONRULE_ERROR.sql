CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_WSLBILLING_BILLINGSRALLOCATIONRULE_ERROR AS SELECT src, 'IPS_WSLBILLING_BILLINGSRALLOCATIONRULE' as TABLE_OBJECT, CASE WHEN 
