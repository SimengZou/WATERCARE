CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_CDR_CODEENFORCEMENT_CASESTATUSCODE_ERROR AS SELECT src, 'IPS_CDR_CODEENFORCEMENT_CASESTATUSCODE' as TABLE_OBJECT, CASE WHEN 
