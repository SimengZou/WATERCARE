CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_RESOURCES_CREDITRATINGPOINTS_ERROR AS SELECT src, 'IPS_RESOURCES_CREDITRATINGPOINTS' as TABLE_OBJECT, CASE WHEN 
