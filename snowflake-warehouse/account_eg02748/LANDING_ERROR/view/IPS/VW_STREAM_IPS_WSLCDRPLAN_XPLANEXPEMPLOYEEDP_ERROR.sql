CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_WSLCDRPLAN_XPLANEXPEMPLOYEEDP_ERROR AS SELECT src, 'IPS_WSLCDRPLAN_XPLANEXPEMPLOYEEDP' as TABLE_OBJECT, CASE WHEN 
