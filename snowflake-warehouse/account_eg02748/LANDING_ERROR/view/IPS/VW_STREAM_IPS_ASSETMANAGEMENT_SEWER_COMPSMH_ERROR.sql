CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_ASSETMANAGEMENT_SEWER_COMPSMH_ERROR AS SELECT src, 'IPS_ASSETMANAGEMENT_SEWER_COMPSMH' as TABLE_OBJECT, CASE WHEN 
