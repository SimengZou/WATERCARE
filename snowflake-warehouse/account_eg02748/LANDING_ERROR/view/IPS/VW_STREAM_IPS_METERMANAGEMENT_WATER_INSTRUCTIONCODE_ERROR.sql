CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_IPS_METERMANAGEMENT_WATER_INSTRUCTIONCODE_ERROR AS SELECT src, 'IPS_METERMANAGEMENT_WATER_INSTRUCTIONCODE' as TABLE_OBJECT, CASE WHEN 
