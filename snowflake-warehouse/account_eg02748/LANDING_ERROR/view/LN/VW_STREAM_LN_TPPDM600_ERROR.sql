CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_LN_TPPDM600_ERROR AS SELECT src, 'LN_TPPDM600' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:bqua), '0'), 38, 10) is null and 
                    src:bqua is not null) THEN
                    'bqua contains a non-numeric value : \'' || AS_VARCHAR(src:bqua) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_ampc_ref_compnr), '0'), 38, 10) is null and 
                    src:cdf_ampc_ref_compnr is not null) THEN
                    'cdf_ampc_ref_compnr contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_ampc_ref_compnr) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_bcpc), '0'), 38, 10) is null and 
                    src:cdf_bcpc is not null) THEN
                    'cdf_bcpc contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_bcpc) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_cpin), '0'), 38, 10) is null and 
                    src:cdf_cpin is not null) THEN
                    'cdf_cpin contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_cpin) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_fwcc), '0'), 38, 10) is null and 
                    src:cdf_fwcc is not null) THEN
                    'cdf_fwcc contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_fwcc) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_fwdc), '0'), 38, 10) is null and 
                    src:cdf_fwdc is not null) THEN
                    'cdf_fwdc contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_fwdc) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_fwdc_ref_compnr), '0'), 38, 10) is null and 
                    src:cdf_fwdc_ref_compnr is not null) THEN
                    'cdf_fwdc_ref_compnr contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_fwdc_ref_compnr) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_fwic), '0'), 38, 10) is null and 
                    src:cdf_fwic is not null) THEN
                    'cdf_fwic contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_fwic) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_grow), '0'), 38, 10) is null and 
                    src:cdf_grow is not null) THEN
                    'cdf_grow contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_grow) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_locn), '0'), 38, 10) is null and 
                    src:cdf_locn is not null) THEN
                    'cdf_locn contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_locn) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_lser), '0'), 38, 10) is null and 
                    src:cdf_lser is not null) THEN
                    'cdf_lser contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_lser) || '\'' WHEN 
                    (TRY_TO_TIMESTAMP(NVL(AS_VARCHAR(src:cdf_pacd), '1900-01-01')) is null and 
                    src:cdf_pacd is not null) THEN
                    'cdf_pacd contains a non-timestamp value : \'' || AS_VARCHAR(src:cdf_pacd) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_prjc), '0'), 38, 10) is null and 
                    src:cdf_prjc is not null) THEN
                    'cdf_prjc contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_prjc) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_prju), '0'), 38, 10) is null and 
                    src:cdf_prju is not null) THEN
                    'cdf_prju contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_prju) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_prju_ref_compnr), '0'), 38, 10) is null and 
                    src:cdf_prju_ref_compnr is not null) THEN
                    'cdf_prju_ref_compnr contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_prju_ref_compnr) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_renw), '0'), 38, 10) is null and 
                    src:cdf_renw is not null) THEN
                    'cdf_renw contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_renw) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_sdtl), '0'), 38, 10) is null and 
                    src:cdf_sdtl is not null) THEN
                    'cdf_sdtl contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_sdtl) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_sqtl), '0'), 38, 10) is null and 
                    src:cdf_sqtl is not null) THEN
                    'cdf_sqtl contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_sqtl) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_svcc), '0'), 38, 10) is null and 
                    src:cdf_svcc is not null) THEN
                    'cdf_svcc contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_svcc) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tcac), '0'), 38, 10) is null and 
                    src:cdf_tcac is not null) THEN
                    'cdf_tcac contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_tcac) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tcbl), '0'), 38, 10) is null and 
                    src:cdf_tcbl is not null) THEN
                    'cdf_tcbl contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_tcbl) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tcfc), '0'), 38, 10) is null and 
                    src:cdf_tcfc is not null) THEN
                    'cdf_tcfc contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_tcfc) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tcfl), '0'), 38, 10) is null and 
                    src:cdf_tcfl is not null) THEN
                    'cdf_tcfl contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_tcfl) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tflc), '0'), 38, 10) is null and 
                    src:cdf_tflc is not null) THEN
                    'cdf_tflc contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_tflc) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tlct), '0'), 38, 10) is null and 
                    src:cdf_tlct is not null) THEN
                    'cdf_tlct contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_tlct) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tlct_ref_compnr), '0'), 38, 10) is null and 
                    src:cdf_tlct_ref_compnr is not null) THEN
                    'cdf_tlct_ref_compnr contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_tlct_ref_compnr) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tmtl), '0'), 38, 10) is null and 
                    src:cdf_tmtl is not null) THEN
                    'cdf_tmtl contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_tmtl) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_trfl), '0'), 38, 10) is null and 
                    src:cdf_trfl is not null) THEN
                    'cdf_trfl contains a non-numeric value : \'' || AS_VARCHAR(src:cdf_trfl) || '\'' WHEN 
                    ...
                    (TRY_TO_TIMESTAMP(NVL(AS_VARCHAR(src:edbg), '1900-01-01')) is null and 
                    src:edbg is not null) THEN
                    'edbg contains a non-timestamp value : \'' || AS_VARCHAR(src:edbg) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:entu_rcmp), '0'), 38, 10) is null and 
                    src:entu_rcmp is not null) THEN
                    'entu_rcmp contains a non-numeric value : \'' || AS_VARCHAR(src:entu_rcmp) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:habo), '0'), 38, 10) is null and 
                    src:habo is not null) THEN
                    'habo contains a non-numeric value : \'' || AS_VARCHAR(src:habo) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:hebo), '0'), 38, 10) is null and 
                    src:hebo is not null) THEN
                    'hebo contains a non-numeric value : \'' || AS_VARCHAR(src:hebo) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:mprj_rcmp), '0'), 38, 10) is null and 
                    src:mprj_rcmp is not null) THEN
                    'mprj_rcmp contains a non-numeric value : \'' || AS_VARCHAR(src:mprj_rcmp) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:pcbq), '0'), 38, 10) is null and 
                    src:pcbq is not null) THEN
                    'pcbq contains a non-numeric value : \'' || AS_VARCHAR(src:pcbq) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:pmfc_rcmp), '0'), 38, 10) is null and 
                    src:pmfc_rcmp is not null) THEN
                    'pmfc_rcmp contains a non-numeric value : \'' || AS_VARCHAR(src:pmfc_rcmp) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:rbqu), '0'), 38, 10) is null and 
                    src:rbqu is not null) THEN
                    'rbqu contains a non-numeric value : \'' || AS_VARCHAR(src:rbqu) || '\'' WHEN 
                    ...
                    (TRY_TO_TIMESTAMP(NVL(AS_VARCHAR(src:rdbg), '1900-01-01')) is null and 
                    src:rdbg is not null) THEN
                    'rdbg contains a non-timestamp value : \'' || AS_VARCHAR(src:rdbg) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:rpcb), '0'), 38, 10) is null and 
                    src:rpcb is not null) THEN
                    'rpcb contains a non-numeric value : \'' || AS_VARCHAR(src:rpcb) || '\'' WHEN 
            ...
            src:sequencenumber desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
                ...
                ROWNUMBER=1) where 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_ampc_ref_compnr), '0'), 38, 10) is null and 
                    src:cdf_ampc_ref_compnr is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_awip), '0'), 38, 10) is null and 
                    src:cdf_awip is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_bcpc), '0'), 38, 10) is null and 
                    src:cdf_bcpc is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_camt), '0'), 38, 10) is null and 
                    src:cdf_camt is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_cpin), '0'), 38, 10) is null and 
                    src:cdf_cpin is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_fwcc), '0'), 38, 10) is null and 
                    src:cdf_fwcc is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_fwdc), '0'), 38, 10) is null and 
                    src:cdf_fwdc is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_fwdc_ref_compnr), '0'), 38, 10) is null and 
                    src:cdf_fwdc_ref_compnr is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_fwic), '0'), 38, 10) is null and 
                    src:cdf_fwic is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_grow), '0'), 38, 10) is null and 
                    src:cdf_grow is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_locn), '0'), 38, 10) is null and 
                    src:cdf_locn is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_lser), '0'), 38, 10) is null and 
                    src:cdf_lser is not null) or 
                    (TRY_TO_TIMESTAMP(NVL(AS_VARCHAR(src:cdf_pacd), '1900-01-01')) is null and 
                    src:cdf_pacd is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_prjc), '0'), 38, 10) is null and 
                    src:cdf_prjc is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_prju), '0'), 38, 10) is null and 
                    src:cdf_prju is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_prju_ref_compnr), '0'), 38, 10) is null and 
                    src:cdf_prju_ref_compnr is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_renw), '0'), 38, 10) is null and 
                    src:cdf_renw is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_sdtl), '0'), 38, 10) is null and 
                    src:cdf_sdtl is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_sqtl), '0'), 38, 10) is null and 
                    src:cdf_sqtl is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_svcc), '0'), 38, 10) is null and 
                    src:cdf_svcc is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tcac), '0'), 38, 10) is null and 
                    src:cdf_tcac is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tcbl), '0'), 38, 10) is null and 
                    src:cdf_tcbl is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tcfc), '0'), 38, 10) is null and 
                    src:cdf_tcfc is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tcfl), '0'), 38, 10) is null and 
                    src:cdf_tcfl is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tflc), '0'), 38, 10) is null and 
                    src:cdf_tflc is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tlct), '0'), 38, 10) is null and 
                    src:cdf_tlct is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tlct_ref_compnr), '0'), 38, 10) is null and 
                    src:cdf_tlct_ref_compnr is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_tmtl), '0'), 38, 10) is null and 
                    src:cdf_tmtl is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_trfl), '0'), 38, 10) is null and 
                    src:cdf_trfl is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:cdf_uamt), '0'), 38, 10) is null and 
                    ...
                    (TRY_TO_TIMESTAMP(NVL(AS_VARCHAR(src:edbg), '1900-01-01')) is null and 
                    src:edbg is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:entu_rcmp), '0'), 38, 10) is null and 
                    src:entu_rcmp is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:espt), '0'), 38, 10) is null and 
                    src:espt is not null) or 
                    (TRY_TO_TIMESTAMP(NVL(AS_VARCHAR(src:fddt), '1900-01-01')) is null and 
                    src:fddt is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:habo), '0'), 38, 10) is null and 
                    src:habo is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:hbpc), '0'), 38, 10) is null and 
                    src:hbpc is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:hebo), '0'), 38, 10) is null and 
                    src:hebo is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:igcd), '0'), 38, 10) is null and 
