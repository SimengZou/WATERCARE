CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_LN_TPPSS010_ERROR AS SELECT src, 'LN_TPPSS010' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:plmd), '0'), 38, 10) is null and 
                    src:plmd is not null) THEN
                    'plmd contains a non-numeric value : \'' || AS_VARCHAR(src:plmd) || '\'' WHEN 
