CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_LN_TPPPC400_ERROR AS SELECT src, 'LN_TPPPC400' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambp_1), '0'), 38, 10) is null and 
                    src:ambp_1 is not null) THEN
                    'ambp_1 contains a non-numeric value : \'' || AS_VARCHAR(src:ambp_1) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambp_2), '0'), 38, 10) is null and 
                    src:ambp_2 is not null) THEN
                    'ambp_2 contains a non-numeric value : \'' || AS_VARCHAR(src:ambp_2) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambp_3), '0'), 38, 10) is null and 
                    src:ambp_3 is not null) THEN
                    'ambp_3 contains a non-numeric value : \'' || AS_VARCHAR(src:ambp_3) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambp_4), '0'), 38, 10) is null and 
                    src:ambp_4 is not null) THEN
                    'ambp_4 contains a non-numeric value : \'' || AS_VARCHAR(src:ambp_4) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambr_1), '0'), 38, 10) is null and 
                    src:ambr_1 is not null) THEN
                    'ambr_1 contains a non-numeric value : \'' || AS_VARCHAR(src:ambr_1) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambr_2), '0'), 38, 10) is null and 
                    src:ambr_2 is not null) THEN
                    'ambr_2 contains a non-numeric value : \'' || AS_VARCHAR(src:ambr_2) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambr_3), '0'), 38, 10) is null and 
                    src:ambr_3 is not null) THEN
                    'ambr_3 contains a non-numeric value : \'' || AS_VARCHAR(src:ambr_3) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambr_4), '0'), 38, 10) is null and 
                    src:ambr_4 is not null) THEN
                    'ambr_4 contains a non-numeric value : \'' || AS_VARCHAR(src:ambr_4) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amdr_1), '0'), 38, 10) is null and 
                    src:amdr_1 is not null) THEN
                    'amdr_1 contains a non-numeric value : \'' || AS_VARCHAR(src:amdr_1) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amdr_2), '0'), 38, 10) is null and 
                    src:amdr_2 is not null) THEN
                    'amdr_2 contains a non-numeric value : \'' || AS_VARCHAR(src:amdr_2) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amdr_3), '0'), 38, 10) is null and 
                    src:amdr_3 is not null) THEN
                    'amdr_3 contains a non-numeric value : \'' || AS_VARCHAR(src:amdr_3) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amdr_4), '0'), 38, 10) is null and 
                    src:amdr_4 is not null) THEN
                    'amdr_4 contains a non-numeric value : \'' || AS_VARCHAR(src:amdr_4) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amds_1), '0'), 38, 10) is null and 
                    src:amds_1 is not null) THEN
                    'amds_1 contains a non-numeric value : \'' || AS_VARCHAR(src:amds_1) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amds_2), '0'), 38, 10) is null and 
                    src:amds_2 is not null) THEN
                    'amds_2 contains a non-numeric value : \'' || AS_VARCHAR(src:amds_2) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amds_3), '0'), 38, 10) is null and 
                    src:amds_3 is not null) THEN
                    'amds_3 contains a non-numeric value : \'' || AS_VARCHAR(src:amds_3) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amds_4), '0'), 38, 10) is null and 
                    src:amds_4 is not null) THEN
                    'amds_4 contains a non-numeric value : \'' || AS_VARCHAR(src:amds_4) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfc_1), '0'), 38, 10) is null and 
                    src:amfc_1 is not null) THEN
                    'amfc_1 contains a non-numeric value : \'' || AS_VARCHAR(src:amfc_1) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfc_2), '0'), 38, 10) is null and 
                    src:amfc_2 is not null) THEN
                    'amfc_2 contains a non-numeric value : \'' || AS_VARCHAR(src:amfc_2) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfc_3), '0'), 38, 10) is null and 
                    src:amfc_3 is not null) THEN
                    'amfc_3 contains a non-numeric value : \'' || AS_VARCHAR(src:amfc_3) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfc_4), '0'), 38, 10) is null and 
                    src:amfc_4 is not null) THEN
                    'amfc_4 contains a non-numeric value : \'' || AS_VARCHAR(src:amfc_4) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfr_1), '0'), 38, 10) is null and 
                    src:amfr_1 is not null) THEN
                    'amfr_1 contains a non-numeric value : \'' || AS_VARCHAR(src:amfr_1) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfr_2), '0'), 38, 10) is null and 
                    src:amfr_2 is not null) THEN
                    'amfr_2 contains a non-numeric value : \'' || AS_VARCHAR(src:amfr_2) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfr_3), '0'), 38, 10) is null and 
                    src:amfr_3 is not null) THEN
                    'amfr_3 contains a non-numeric value : \'' || AS_VARCHAR(src:amfr_3) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfr_4), '0'), 38, 10) is null and 
                    src:amfr_4 is not null) THEN
                    'amfr_4 contains a non-numeric value : \'' || AS_VARCHAR(src:amfr_4) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrf_1), '0'), 38, 10) is null and 
                    src:amrf_1 is not null) THEN
                    'amrf_1 contains a non-numeric value : \'' || AS_VARCHAR(src:amrf_1) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrf_2), '0'), 38, 10) is null and 
                    src:amrf_2 is not null) THEN
                    'amrf_2 contains a non-numeric value : \'' || AS_VARCHAR(src:amrf_2) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrf_3), '0'), 38, 10) is null and 
                    src:amrf_3 is not null) THEN
                    'amrf_3 contains a non-numeric value : \'' || AS_VARCHAR(src:amrf_3) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrf_4), '0'), 38, 10) is null and 
                    src:amrf_4 is not null) THEN
                    'amrf_4 contains a non-numeric value : \'' || AS_VARCHAR(src:amrf_4) || '\'' WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:mprj_ref_compnr), '0'), 38, 10) is null and 
                    src:mprj_ref_compnr is not null) THEN
                    'mprj_ref_compnr contains a non-numeric value : \'' || AS_VARCHAR(src:mprj_ref_compnr) || '\'' WHEN 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:mpto), '0'), 38, 10) is null and 
                    src:mpto is not null) THEN
                    'mpto contains a non-numeric value : \'' || AS_VARCHAR(src:mpto) || '\'' WHEN 
            ...
            src:sequencenumber desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
                ...
                ROWNUMBER=1) where 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambp_1), '0'), 38, 10) is null and 
                    src:ambp_1 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambp_2), '0'), 38, 10) is null and 
                    src:ambp_2 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambp_3), '0'), 38, 10) is null and 
                    src:ambp_3 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambp_4), '0'), 38, 10) is null and 
                    src:ambp_4 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambr_1), '0'), 38, 10) is null and 
                    src:ambr_1 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambr_2), '0'), 38, 10) is null and 
                    src:ambr_2 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambr_3), '0'), 38, 10) is null and 
                    src:ambr_3 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ambr_4), '0'), 38, 10) is null and 
                    src:ambr_4 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amdr_1), '0'), 38, 10) is null and 
                    src:amdr_1 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amdr_2), '0'), 38, 10) is null and 
                    src:amdr_2 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amdr_3), '0'), 38, 10) is null and 
                    src:amdr_3 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amdr_4), '0'), 38, 10) is null and 
                    src:amdr_4 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amds_1), '0'), 38, 10) is null and 
                    src:amds_1 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amds_2), '0'), 38, 10) is null and 
                    src:amds_2 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amds_3), '0'), 38, 10) is null and 
                    src:amds_3 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amds_4), '0'), 38, 10) is null and 
                    src:amds_4 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amep_1), '0'), 38, 10) is null and 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfc_1), '0'), 38, 10) is null and 
                    src:amfc_1 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfc_2), '0'), 38, 10) is null and 
                    src:amfc_2 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfc_3), '0'), 38, 10) is null and 
                    src:amfc_3 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfc_4), '0'), 38, 10) is null and 
                    src:amfc_4 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfr_1), '0'), 38, 10) is null and 
                    src:amfr_1 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfr_2), '0'), 38, 10) is null and 
                    src:amfr_2 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfr_3), '0'), 38, 10) is null and 
                    src:amfr_3 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amfr_4), '0'), 38, 10) is null and 
                    src:amfr_4 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:ampe_1), '0'), 38, 10) is null and 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrf_1), '0'), 38, 10) is null and 
                    src:amrf_1 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrf_2), '0'), 38, 10) is null and 
                    src:amrf_2 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrf_3), '0'), 38, 10) is null and 
                    src:amrf_3 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrf_4), '0'), 38, 10) is null and 
                    src:amrf_4 is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:amrp_1), '0'), 38, 10) is null and 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:mprj_ref_compnr), '0'), 38, 10) is null and 
                    src:mprj_ref_compnr is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:mpto), '0'), 38, 10) is null and 
                    src:mpto is not null) or 
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:sequencenumber), '0'), 38, 10) is null and 
