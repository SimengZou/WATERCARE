CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_LN_TFFBS100_ERROR AS SELECT src, 'LN_TFFBS100' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:pdmo), '0'), 38, 10) is null and 
                    src:pdmo is not null) THEN
                    'pdmo contains a non-numeric value : \'' || AS_VARCHAR(src:pdmo) || '\'' WHEN 
