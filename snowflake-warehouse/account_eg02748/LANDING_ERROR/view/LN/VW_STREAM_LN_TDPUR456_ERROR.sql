CREATE OR REPLACE VIEW LANDING_ERROR.VW_STREAM_LN_TDPUR456_ERROR AS SELECT src, 'LN_TDPUR456' as TABLE_OBJECT, CASE WHEN 
                    ...
                    (TRY_TO_NUMERIC(NVL(AS_VARCHAR(src:hisa), '0'), 38, 10) is null and 
                    src:hisa is not null) THEN
                    'hisa contains a non-numeric value : \'' || AS_VARCHAR(src:hisa) || '\'' WHEN 
