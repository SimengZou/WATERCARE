CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_TOOL
AS
SELECT 
...
, XTOOL.SUBTYPEFEATURES::VARCHAR(10) AS "SubType Features"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XTOOL.FUELTYPE::VARCHAR(10) AS "Fuel Type"
, XTOOL.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XTOOL.IPRATING::VARCHAR(10) AS "Ingress Protection Rating"
, XTOOL.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XTOOL AS XTOOL ON A2.COMPKEY = XTOOL.COMPKEY 
 WHERE A4.COMPCODE = 'TOOL';