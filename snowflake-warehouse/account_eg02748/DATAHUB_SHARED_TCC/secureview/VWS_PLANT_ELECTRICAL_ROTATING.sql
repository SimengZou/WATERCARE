CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_ELECTRICAL_ROTATING
AS
SELECT 
...
, XELECTROTATE.BEARINGTYPE::VARCHAR(1) AS "Bearing Type"
, XELECTROTATE.DESIGNSPEED::FLOAT AS "Design Speed (RPM)"
, XELECTROTATE.ENERGYRATING::NUMBER(38,0) AS "Energy Rating (Kw)"
, XELECTROTATE.FRAMESIZE::VARCHAR(10) AS "Frame Size"
, XELECTROTATE.CURRENTIN::FLOAT AS "Input Current (Amps)"
, XELECTROTATE.VOLTAGEIN::FLOAT AS "Input Voltage (Volt)"
, XELECTROTATE.VOLTAGEINTYPE::VARCHAR(2) AS "Input Voltage Type"
, XELECTROTATE.CURRENTOUT::FLOAT AS "Output Current (Amps)"
, XELECTROTATE.VOLTAGEOUT::FLOAT AS "Output Voltage (Volt)"
, XELECTROTATE.VOLTAGEOUTTYPE::VARCHAR(2) AS "Output Voltage Type"
, XELECTROTATE.PHASES::VARCHAR(10) AS "Phases"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XELECTROTATE.COOLING::VARCHAR(1) AS "Cooling"
, XELECTROTATE.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XELECTROTATE.HAZARDRATING::VARCHAR(10) AS "Hazardous Rating"
, XELECTROTATE.IPRATING::VARCHAR(10) AS "Ingress Protection Rating"
, XELECTROTATE.INSTALLMOUNT::VARCHAR(1) AS "Installation Mounting"
, XELECTROTATE.INSTALLORIENT::VARCHAR(1) AS "Installation Orientation"
, XELECTROTATE.INSULATIONCLASS::VARCHAR(10) AS "Insulation Class"
, XELECTROTATE.LOCALITY::VARCHAR(10) AS "Locality"
, XELECTROTATE.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
, XELECTROTATE.TORQUEOUT::FLOAT AS "Torque Output Rating"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XELECTROTATE AS XELECTROTATE ON A2.COMPKEY = XELECTROTATE.COMPKEY 
 WHERE A4.COMPCODE = 'ELRO';
