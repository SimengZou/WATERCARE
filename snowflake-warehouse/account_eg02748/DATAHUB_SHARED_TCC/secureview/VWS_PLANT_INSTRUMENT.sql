CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_INSTRUMENT
AS
SELECT 
...
, XINSTRUMENT.VOLTAGEIN::FLOAT AS "Input Voltage (Volt)"
, XINSTRUMENT.VOLTAGEINTYPE::VARCHAR(2) AS "Input Voltage Type"
, XINSTRUMENT.VOLTAGEOUT::FLOAT AS "Output Voltage (Volt)"
, XINSTRUMENT.PRESSURERATING::FLOAT AS "Pressure Rating (kPa)"
, XINSTRUMENT.SUBTYPEFEATURES::VARCHAR(10) AS "SubType Features"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XINSTRUMENT.COMMSPROTOCOL::VARCHAR(10) AS "Communications Protocol"
, XINSTRUMENT.EXTCOAT::VARCHAR(10) AS "External Coating"
, XINSTRUMENT.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XINSTRUMENT.GRDLEVEL::FLOAT AS "Ground Level"
, XINSTRUMENT.HAZARDRATING::VARCHAR(10) AS "Hazardous Rating"
, XINSTRUMENT.IPRATING::VARCHAR(10) AS "Ingress Protection Rating"
, XINSTRUMENT.INSTALLMOUNT::VARCHAR(1) AS "Installation Mounting"
, XINSTRUMENT.INSTRUMENTRANGE::VARCHAR(30) AS "Instrument Range"
, XINSTRUMENT.INSULATIONCLASS::VARCHAR(10) AS "Insulation Class"
, XINSTRUMENT.INTLINING::VARCHAR(10) AS "Internal Lining"
, XINSTRUMENT.JTTYPE::VARCHAR(10) AS "Joint Method"
, XINSTRUMENT.LOCALITY::VARCHAR(10) AS "Locality"
, XINSTRUMENT.MAXFLOW::FLOAT AS "Maximum Flow"
, XINSTRUMENT.MINFLOW::FLOAT AS "Minimum Flow"
, XINSTRUMENT.MEDIATYPE::VARCHAR(10) AS "Media Type"
, XINSTRUMENT.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XINSTRUMENT AS XINSTRUMENT ON A2.COMPKEY = XINSTRUMENT.COMPKEY 
 WHERE A4.COMPCODE = 'INST';
