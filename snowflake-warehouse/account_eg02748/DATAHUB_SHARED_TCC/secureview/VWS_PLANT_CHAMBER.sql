CREATE OR REPLACE SECURE VIEW DATAHUB_SHARED_TCC.VWS_PLANT_CHAMBER
AS
SELECT 
...
, XCHAMBER.BOLTDOWN::VARCHAR(1) AS "Boltdown"
, XCHAMBER.COVERTYPE::VARCHAR(10) AS "Cover Type"
, XCHAMBER.DIAMEXT::FLOAT AS "Diameter External (mm)"
, XCHAMBER.DIAMINT::FLOAT AS "Diameter Internal (mm)"
, XCHAMBER.HINGED::VARCHAR(1) AS "Hinged"
, XCHAMBER.INVLEVEL::FLOAT AS "Invert Level (M)"
, XCHAMBER.DROPMH::VARCHAR(1) AS "Is Drop Manhole"
, XCHAMBER.LIDLEVEL::FLOAT AS "Lid Level (M)"
, XCHAMBER.LOCKABLE::VARCHAR(1) AS "Lockable"
, XCHAMBER.OVERFLOWTYPE::VARCHAR(10) AS "Overflow Type"
, XCHAMBER.REMOVABLE::VARCHAR(1) AS "Removable"
, XCHAMBER.SUBTYPEFEATURES::VARCHAR(10) AS "SubType Features"
, A1.WARRANTYEND::TIMESTAMP_NTZ(9) AS "Warranty End Date"
, A1.WARRANTYSTART::TIMESTAMP_NTZ(9) AS "Warranty Start Date"
, XCHAMBER.DESIGNRESILIENCE::VARCHAR(10) AS "Design Resilience"
, XCHAMBER.QUAKEDESIGN::VARCHAR(10) AS "Earthquake Design Level"
, XCHAMBER.FALLPROTECT::VARCHAR(1) AS "Fall Protection"
, XCHAMBER.FUNCAREA::VARCHAR(10) AS "Functional Area"
, XCHAMBER.GRDLEVEL::FLOAT AS "Ground Level"
, XCHAMBER.INTLINING::VARCHAR(10) AS "Internal Lining"
, XCHAMBER.LOADRATING::FLOAT AS "Load Rating (kN)"
, XCHAMBER.LOCALITY::VARCHAR(10) AS "Locality"
, XCHAMBER.MEDIATYPE::VARCHAR(10) AS "Media Type"
, XCHAMBER.PHOTO3D::VARCHAR(300) AS "Photo/3D Model"
FROM
 ...
 LEFT OUTER JOIN DATAHUB_TARGET.IPS_WSLASSETSCONFIGURED_XCHAMBER AS XCHAMBER ON A2.COMPKEY = XCHAMBER.COMPKEY 
 WHERE A4.COMPCODE = 'CHAM';
