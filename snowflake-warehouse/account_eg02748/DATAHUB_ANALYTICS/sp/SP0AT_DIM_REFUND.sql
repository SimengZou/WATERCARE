CREATE OR REPLACE PROCEDURE "SP0AT_DIM_REFUND"()
...
//  Run merge statement
			...
			sql_command += "  ACCTTRAN.REFUND_KEY,";
			sql_command += "  ''Not Available'' AS REFUND_COMMENTS,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_REFUND REFUND ON ACCTTRAN.REFUND_KEY =REFUND.REFUND_KEY";
			sql_command += "    WHERE REFUND.REFUND_KEY IS NULL AND ACCTTRAN.REFUND_KEY IS NOT NULL";
