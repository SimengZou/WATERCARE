CREATE OR REPLACE PROCEDURE "SP0MR_DIM_READER_CODE"()
...
//  Run merge statement
	        ...
	        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_READER_CODE target USING (SELECT  ";
			sql_command += "  READING.READER_CODE,";
			sql_command += "  ''Not Available'' AS READER_CODE_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_READER_CODE READERCODE ON upper(READING.READER_CODE)= upper(READERCODE.READER_CODE)";
			sql_command += " WHERE READERCODE.READER_CODE IS NULL AND READING.READER_CODE IS NOT NULL";
			sql_command += " GROUP BY 1";
			sql_command += "  ) AS b ON upper(target.READER_CODE) = upper(b.READER_CODE)";
			sql_command += "  WHEN NOT MATCHED THEN INSERT (READER_CODE, ";
			...
			sql_command += "  VALUES (b.READER_CODE, ";
			sql_command += "  b.READER_CODE_DESCRIPTION ,";
