CREATE OR REPLACE PROCEDURE "SP_DIM_BILL_RUN"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_BILL_RUN target USING (SELECT  ";
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_BILL_RUN";
		sql_command += " ) AS b ON target.BILL_RUN_key =b.BILL_RUN_key";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += " SET target.NUMBER_OF_BILLS_IN_RUN =b.NUMBER_OF_BILLS_IN_RUN ,";
		sql_command += " target.NUMBER_OF_EXCEPTIONS =b.NUMBER_OF_EXCEPTIONS ,";
		sql_command += " target.BILL_RUN_POSTED_FLAG =b.BILL_RUN_POSTED_FLAG ,";
		sql_command += " target.BILL_RUN_ADDED_DATE =b.BILL_RUN_ADDED_DATE ,";
		sql_command += " target.BILL_RUN_BILLING_CYCLE =b.BILL_RUN_BILLING_CYCLE ,";
		sql_command += " target.PRINCIPAL_TOTAL =b.PRINCIPAL_TOTAL ,";
		sql_command += " target.BILLING_PERIOD_FROM_DATE =b.BILLING_PERIOD_FROM_DATE ,";
		sql_command += " target.BILLING_PERIOD_TO_DATE =b.BILLING_PERIOD_TO_DATE ,";
		sql_command += " target.BILLING_STATUS =b.BILLING_STATUS ,";
		sql_command += " target.BILL_RUN_DESCRIPTION =b.BILL_RUN_DESCRIPTION ,";
		sql_command += " target.RUN_TYPE =b.RUN_TYPE ,";
		sql_command += " target.TOTAL_NUMBER_OF_BILLS =b.TOTAL_NUMBER_OF_BILLS ,";
		sql_command += " target.ETL_SOURCE_DATETIME =b.ETL_SOURCE_DATETIME ,";
		sql_command += " target.ETL_RECORD_UPDATED =current_timestamp()";
		sql_command += " WHEN NOT MATCHED THEN INSERT (BILL_RUN_KEY, ";
		sql_command += " NUMBER_OF_BILLS_IN_RUN, ";
		sql_command += " NUMBER_OF_EXCEPTIONS, ";
		sql_command += " BILL_RUN_POSTED_FLAG, ";
		sql_command += " BILL_RUN_ADDED_DATE, ";
		...
		sql_command += " ETL_RECORD_CREATED, ";
		sql_command += " ETL_RECORD_UPDATED)";
		sql_command += " VALUES (b.BILL_RUN_KEY, ";
		sql_command += " b.NUMBER_OF_BILLS_IN_RUN ,";
		sql_command += " b.NUMBER_OF_EXCEPTIONS ,";
		sql_command += " b.BILL_RUN_POSTED_FLAG ,";
		sql_command += " b.BILL_RUN_ADDED_DATE ,";
		sql_command += " b.BILL_RUN_BILLING_CYCLE ,";
		sql_command += " b.PRINCIPAL_TOTAL ,";
		sql_command += " b.BILLING_PERIOD_FROM_DATE ,";
		sql_command += " b.BILLING_PERIOD_TO_DATE ,";
		sql_command += " b.BILLING_STATUS ,";
		sql_command += " b.BILL_RUN_DESCRIPTION ,";
		sql_command += " b.RUN_TYPE ,";
		sql_command += " b.TOTAL_NUMBER_OF_BILLS ,";
