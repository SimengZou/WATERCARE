CREATE OR REPLACE PROCEDURE "SP_DIM_READER_CODE"()
...
//  Run merge statement
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_READER_CODE";
		sql_command += " ) AS b ON target.READER_CODE =b.READER_CODE";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += "  SET target.READER_CODE_DESCRIPTION = b.READER_CODE_DESCRIPTION,";
