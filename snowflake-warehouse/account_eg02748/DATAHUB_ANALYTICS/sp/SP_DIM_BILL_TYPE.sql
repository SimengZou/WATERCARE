CREATE OR REPLACE PROCEDURE "SP_DIM_BILL_TYPE"()
...
//  Run merge statement
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_BILL_TYPE";
		sql_command += " ) AS b ON target.BILL_TYPE_key =b.BILL_TYPE_key";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += " SET target.BILL_TYPE =b.BILL_TYPE ,";
		sql_command += " target.BILL_TYPE_DESCRIPTION =b.BILL_TYPE_DESCRIPTION ,";
