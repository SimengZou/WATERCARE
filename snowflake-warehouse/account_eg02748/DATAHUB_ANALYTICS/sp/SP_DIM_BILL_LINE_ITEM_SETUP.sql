CREATE OR REPLACE PROCEDURE "SP_DIM_BILL_LINE_ITEM_SETUP"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_BILL_LINE_ITEM_SETUP target USING (SELECT  ";
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_BILL_LINE_ITEM_SETUP";
		sql_command += " ) AS b ON target.BILL_LINE_ITEM_SETUP_KEY =b.BILL_LINE_ITEM_SETUP_KEY";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += " SET target.BILL_LINE_ITEM_CODE =b.BILL_LINE_ITEM_CODE ,";
		sql_command += " target.BILL_LINE_ITEM_DESCRIPTION =b.BILL_LINE_ITEM_DESCRIPTION ,";
		sql_command += " target.BILL_LINE_ITEM_DESIGNATION =b.BILL_LINE_ITEM_DESIGNATION ,";
		sql_command += " target.BILL_LINE_ITEM_DESIGNATION_DESCRIPTION =b.BILL_LINE_ITEM_DESIGNATION_DESCRIPTION ,";
		sql_command += " target.BILL_LINE_ITEM_EFFECTIVE_DATE =b.BILL_LINE_ITEM_EFFECTIVE_DATE ,";
		sql_command += " target.BILL_LINE_ITEM_GROUP =b.BILL_LINE_ITEM_GROUP ,";
		sql_command += " target.FEE_TYPE_KEY=b.FEE_TYPE_KEY,";
		sql_command += " target.PRINT_TEXT=b.PRINT_TEXT,";
		...
		sql_command += " ETL_RECORD_UPDATED)";
		sql_command += " VALUES ( ";
		sql_command += " b.BILL_LINE_ITEM_SETUP_KEY ,";
		sql_command += " b.BILL_LINE_ITEM_CODE ,";
		sql_command += " b.BILL_LINE_ITEM_DESCRIPTION ,";
		sql_command += " b.BILL_LINE_ITEM_DESIGNATION ,";
		sql_command += " b.BILL_LINE_ITEM_DESIGNATION_DESCRIPTION ,";
		sql_command += " b.BILL_LINE_ITEM_EFFECTIVE_DATE ,";
		sql_command += " b.BILL_LINE_ITEM_GROUP ,";
		sql_command += " b.FEE_TYPE_KEY,";
		sql_command += " b.PRINT_TEXT,";
