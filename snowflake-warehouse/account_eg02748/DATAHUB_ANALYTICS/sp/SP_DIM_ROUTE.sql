CREATE OR REPLACE PROCEDURE "SP_DIM_ROUTE"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_ROUTE target USING (SELECT  ";
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_ROUTE";
		sql_command += " ) AS b ON target.ROUTE_KEY =b.ROUTE_KEY";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += "  SET target.ROUTE_DESCRIPTION = b.ROUTE_DESCRIPTION,";
		sql_command += " target.ROUTE_ID = b.ROUTE_ID,";
		sql_command += " target.LAST_READ_DATE = b.LAST_READ_DATE, ";
		sql_command += " target.NEXT_READ_DATE = b.NEXT_READ_DATE, ";
		sql_command += " target.BILLING_ROUTE_FLAG = b.BILLING_ROUTE_FLAG, ";
		sql_command += " target.OUT_FOR_ACTIVITY_FLAG = b.OUT_FOR_ACTIVITY_FLAG, ";
		sql_command += " target.READING_CYCLE = b.READING_CYCLE, ";
		sql_command += " target.TIME_INTERVAL = b.TIME_INTERVAL, ";
		sql_command += " target.TIME_INTERVAL_UNIT = b.TIME_INTERVAL_UNIT, ";
		sql_command += " target.ETL_SOURCE_DATETIME=b.ETL_SOURCE_DATETIME , ";
		sql_command += " target.ETL_RECORD_UPDATED =current_timestamp()";
		sql_command += " WHEN NOT MATCHED THEN INSERT (ROUTE_KEY, ";
		sql_command += " ROUTE_DESCRIPTION, ";
		sql_command += " ROUTE_ID, ";
		sql_command += " LAST_READ_DATE, ";
		sql_command += " NEXT_READ_DATE, ";
		...
		sql_command += " ETL_RECORD_CREATED, ";
		sql_command += " ETL_RECORD_UPDATED)";
		sql_command += " VALUES (b.ROUTE_KEY, ";
		sql_command += " b.ROUTE_DESCRIPTION, ";
		sql_command += " b.ROUTE_ID,";
		sql_command += " b.LAST_READ_DATE, ";
		sql_command += " b.NEXT_READ_DATE, ";
		sql_command += " b.BILLING_ROUTE_FLAG, ";
		sql_command += " b.OUT_FOR_ACTIVITY_FLAG, ";
		sql_command += " b.READING_CYCLE, ";
		sql_command += " b.TIME_INTERVAL, ";
		sql_command += " b.TIME_INTERVAL_UNIT, ";
