CREATE OR REPLACE PROCEDURE "SP_DIM_REFUND"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_REFUND target USING (SELECT  ";
			...
			sql_command += "  FROM DATAHUB_STAGING.STG_DIM_REFUND";
			sql_command += "  ) AS b ON target.REFUND_key =b.REFUND_key";
			sql_command += "  WHEN MATCHED THEN UPDATE ";
			sql_command += "  SET target.REFUND_KEY =b.REFUND_KEY ,";
			sql_command += "  target.REFUND_STATUS_CODE =b.REFUND_STATUS_CODE ,";
			sql_command += "  target.REFUND_STATUS_DESCRIPTION =b.REFUND_STATUS_DESCRIPTION ,";
			sql_command += "  target.REFUND_REASON_CODE =b.REFUND_REASON_CODE ,";
			sql_command += "  target.REFUND_REASON_DESCRIPTION =b.REFUND_REASON_DESCRIPTION ,";
			sql_command += "  target.REFUND_COMMENTS =b.REFUND_COMMENTS ,";
			sql_command += "  target.REFUND_ADDED_BY =b.REFUND_ADDED_BY ,";
			sql_command += "  target.REFUND_MODIFIED_BY =b.REFUND_MODIFIED_BY ,";
			sql_command += "  target.REFUNDED_BY =b.REFUNDED_BY ,";
			sql_command += "  target.REFUND_STATUS_BY =b.REFUND_STATUS_BY ,";
			sql_command += "  target.REFUNDED_DATE =b.REFUNDED_DATE ,";
			sql_command += "  target.REFUND_STATUS_DATE =b.REFUND_STATUS_DATE ,";
			sql_command += "  target.REFUND_ADDED_DATE =b.REFUND_ADDED_DATE ,";
			sql_command += "  target.REFUND_MODIFIED_DATE =b.REFUND_MODIFIED_DATE ,";
			sql_command += "  target.ETL_SOURCE_DATETIME =b.ETL_SOURCE_DATETIME ,";
			sql_command += "  target.ETL_RECORD_UPDATED =current_timestamp()";
			sql_command += "  WHEN NOT MATCHED THEN INSERT (REFUND_KEY, ";
			sql_command += " REFUND_STATUS_CODE, ";
			sql_command += " REFUND_STATUS_DESCRIPTION, ";
			sql_command += " REFUND_REASON_CODE, ";
			sql_command += " REFUND_REASON_DESCRIPTION, ";
			...
			sql_command += " ETL_RECORD_CREATED, ";
			sql_command += " ETL_RECORD_UPDATED )";
			sql_command += "  VALUES ( b.REFUND_KEY ,";
			sql_command += "  b.REFUND_STATUS_CODE ,";
			sql_command += "  b.REFUND_STATUS_DESCRIPTION ,";
			sql_command += "  b.REFUND_REASON_CODE ,";
			sql_command += "  b.REFUND_REASON_DESCRIPTION ,";
			sql_command += "  b.REFUND_COMMENTS ,";
			sql_command += "  b.REFUND_ADDED_BY ,";
			sql_command += "  b.REFUND_MODIFIED_BY ,";
			sql_command += "  b.REFUNDED_BY ,";
			sql_command += "  b.REFUND_STATUS_BY ,";
			sql_command += "  b.REFUNDED_DATE ,";
			sql_command += "  b.REFUND_STATUS_DATE ,";
			sql_command += "  b.REFUND_ADDED_DATE ,";
			sql_command += "  b.REFUND_MODIFIED_DATE ,";
