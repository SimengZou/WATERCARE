CREATE OR REPLACE PROCEDURE "SP0AT_DIM_BILL"()
...
//  Run merge statement
			...
			sql_command += "  ACCTTRAN.BILL_KEY,";
			sql_command += "  ''Not Available'' AS BILL_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_BILL BILL ON ACCTTRAN.BILL_KEY =BILL.BILL_KEY";
			sql_command += "    WHERE BILL.BILL_KEY IS NULL AND ACCTTRAN.BILL_KEY IS NOT NULL";
