CREATE OR REPLACE PROCEDURE "SP0MR_DIM_EMPLOYEE"()
...
//  Run merge statement
	        ...
	        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_EMPLOYEE target USING (SELECT  ";
			sql_command += "  READING.READ_BY AS EMPLOYEE_CODE,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_EMPLOYEE EMPLOYEE ON upper(READING.READ_BY)= upper(EMPLOYEE.EMPLOYEE_CODE)";
			sql_command += " WHERE EMPLOYEE.EMPLOYEE_CODE IS NULL AND READING.READ_BY IS NOT NULL";
