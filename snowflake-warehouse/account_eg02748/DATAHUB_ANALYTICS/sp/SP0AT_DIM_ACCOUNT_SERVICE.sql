CREATE OR REPLACE PROCEDURE "SP0AT_DIM_ACCOUNT_SERVICE"()
...
//  Run merge statement
			...
			sql_command += "  ACCTTRAN.ACCOUNT_SERVICE_KEY,";
			sql_command += "  ''Not Available'' AS SERVICE_DESCRIPTION,";
			...
			sql_command += "   LEFT JOIN DATAHUB_ANALYTICS.DIM_ACCOUNT_SERVICE ACCOUNTSERVICE ON ACCTTRAN.ACCOUNT_SERVICE_KEY=ACCOUNTSERVICE.ACCOUNT_SERVICE_KEY";
			sql_command += "    WHERE ACCOUNTSERVICE.ACCOUNT_SERVICE_KEY IS NULL AND ACCTTRAN.ACCOUNT_SERVICE_KEY IS NOT NULL";
