CREATE OR REPLACE PROCEDURE "SP_DIM_PAYMENT"()
...
//  Run merge statement
        ...
        var sql_command = "MERGE INTO DATAHUB_ANALYTICS.DIM_PAYMENT target USING (SELECT  ";
		sql_command += " PAY_KEY, ";
		...
		sql_command += " FROM DATAHUB_STAGING.STG_DIM_PAYMENT";
		sql_command += " ) AS b ON target.PAY_key =b.PAY_key";
		sql_command += " WHEN MATCHED THEN UPDATE ";
		sql_command += " SET target.PAY_KEY=b.PAY_KEY,";
		sql_command += " target.PAYMENT_ADDED_DATE =b.PAYMENT_ADDED_DATE ,";
		sql_command += " target.PAYMENT_MODIFIED_DATE =b.PAYMENT_MODIFIED_DATE ,";
		sql_command += " target.PAYMENT_METHOD =b.PAYMENT_METHOD ,";
		sql_command += " target.PAYMENT_MISC_TYPE =b.PAYMENT_MISC_TYPE ,";
		sql_command += " target.PAYMENT_REVERSAL_CODE =b.PAYMENT_REVERSAL_CODE ,";
		sql_command += " target.PAYMENT_REVERSAL_REASON =b.PAYMENT_REVERSAL_REASON ,";
		sql_command += " target.PAYMENT_RESOLUTION_CODE =b.PAYMENT_RESOLUTION_CODE ,";
		sql_command += " target.PAYMENT_RESOLUTION =b.PAYMENT_RESOLUTION ,";
		sql_command += " target.PAYMENT_SOURCE =b.PAYMENT_SOURCE ,";
		sql_command += " target.PAYMENT_STATUS =b.PAYMENT_STATUS ,";
		sql_command += " target.BATCH_NUMBER =b.BATCH_NUMBER ,";
		sql_command += " target.BATCH_KEY =b.BATCH_KEY ,";
		sql_command += " target.PAYMENT_RECEIVED_BY =b.PAYMENT_RECEIVED_BY ,";
		sql_command += " target.PAYMENT_RECEIVED_DATE =b.PAYMENT_RECEIVED_DATE ,";
		sql_command += " target.PAYMENT_COMMENTS =b.PAYMENT_COMMENTS ,";
		sql_command += " target.PAYMENT_ADDED_BY =b.PAYMENT_ADDED_BY ,";
		sql_command += " target.PAYMENT_MODIFIED_BY =b.PAYMENT_MODIFIED_BY ,";
		sql_command += " target.ETL_SOURCE_DATETIME =b.ETL_SOURCE_DATETIME ,";
		sql_command += " target.ETL_RECORD_UPDATED =current_timestamp()";
		sql_command += " WHEN NOT MATCHED THEN INSERT (PAY_KEY, ";
		sql_command += " PAYMENT_ADDED_DATE, ";
		sql_command += " PAYMENT_MODIFIED_DATE, ";
		sql_command += " PAYMENT_METHOD, ";
		sql_command += " PAYMENT_MISC_TYPE, ";
		...
		sql_command += " ETL_RECORD_UPDATED)";
		sql_command += " VALUES (b.PAY_KEY, ";
		sql_command += " b.PAYMENT_ADDED_DATE ,";
		sql_command += " b.PAYMENT_MODIFIED_DATE ,";
		sql_command += " b.PAYMENT_METHOD ,";
		sql_command += " b.PAYMENT_MISC_TYPE ,";
		sql_command += " b.PAYMENT_REVERSAL_CODE ,";
		sql_command += " b.PAYMENT_REVERSAL_REASON ,";
		sql_command += " b.PAYMENT_RESOLUTION_CODE ,";
		sql_command += " b.PAYMENT_RESOLUTION ,";
		sql_command += " b.PAYMENT_SOURCE ,";
		sql_command += " b.PAYMENT_STATUS ,";
		sql_command += " b.BATCH_NUMBER ,";
		sql_command += " b.BATCH_KEY ,";
		sql_command += " b.PAYMENT_RECEIVED_BY ,";
		sql_command += " b.PAYMENT_RECEIVED_DATE ,";
		sql_command += " b.PAYMENT_COMMENTS ,";
		sql_command += " b.PAYMENT_ADDED_BY ,";
		sql_command += " b.PAYMENT_MODIFIED_BY ,";
