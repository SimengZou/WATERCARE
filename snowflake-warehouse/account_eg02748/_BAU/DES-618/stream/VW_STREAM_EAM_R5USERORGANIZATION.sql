CREATE OR REPLACE VIEW DATAHUB_INTEGRATION.VW_STREAM_EAM_R5USERORGANIZATION
            AS
            SELECT
                ...
                src:"UOG_ORG"::varchar,
                src:"UOG_ROLE"::varchar,
                src:"UOG_USER"::varchar,
                src:"UOG_LASTSAVED"::datetime
                ,src,
                etl_load_datetime,
                etl_load_metadatafilename,
                ...
                src:"UOG_ORG"::varchar,
                src:"UOG_ROLE"::varchar,
                src:"UOG_USER"::varchar  ORDER BY 
                src:"UOG_LASTSAVED"::datetime desc,IFNULL(TRY_TO_TIMESTAMP(replace(right(replace(lower(etl_load_metadatafilename),'.json'),23),'_','-'), 'yyyy-mm-dd-HH-MI-SS-FF') ,etl_load_datetime) desc) as ROWNUMBER
