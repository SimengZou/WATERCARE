                ...
                create or replace procedure DATAHUB_INTEGRATION.EAM_TARGET_MERGE_U5DIMENSION3()
              ...
              //  Start execution - log start
                ...
                snowflake.execute( {sqlText: "begin transaction;"} );
                  try
                      ...
                      var sql_command = `      
                                merge into  "DATAHUB_TARGET"."EAM_U5DIMENSION3" as target using (
...
`
  merge into  "DATAHUB_TARGET_HISTORY"."EAM_DELETED_U5DIMENSION3" as target using (
