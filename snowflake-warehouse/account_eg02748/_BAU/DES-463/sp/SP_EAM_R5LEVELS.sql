                ...
                create or replace procedure DATAHUB_INTEGRATION.EAM_TARGET_MERGE_R5LEVELS()
              ...
              //  Start execution - log start
                ...
                snowflake.execute( {sqlText: "begin transaction;"} );
                  try
                      ...
                      var sql_command = `      
                                merge into  "DATAHUB_TARGET"."EAM_R5LEVELS" as target using (
                    ...
                    SELECT * FROM (SELECT
                     ...
                     FROM DATAHUB_INTEGRATION.VW_STREAM_EAM_R5LEVELS as  strm
                     )   
                WHERE ROWNUMBER=1  
                    ...
                    when matched then update set
                                target.LVL_LEVEL=src.LVL_LEVEL,
                                target.LVL_UPDATECOUNT=src.LVL_UPDATECOUNT,
                                target.LVL_LASTSAVED=src.LVL_LASTSAVED,
...
`
  merge into  "DATAHUB_TARGET_HISTORY"."EAM_DELETED_R5LEVELS" as target using (
