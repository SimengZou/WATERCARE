                ...
                create or replace procedure DATAHUB_INTEGRATION.EAM_TARGET_MERGE_R5MAILURLMAPPING()
              ...
              //  Start execution - log start
                ...
                snowflake.execute( {sqlText: "begin transaction;"} );
                  try
                      ...
                      var sql_command = `      
                                merge into  "DATAHUB_TARGET"."EAM_R5MAILURLMAPPING" as target using (
                    ...
                    SELECT * FROM (SELECT
                     ...
                     FROM DATAHUB_INTEGRATION.VW_STREAM_EAM_R5MAILURLMAPPING as  strm
                     )   
                WHERE ROWNUMBER=1  
                    ...
                    when matched then update set
                                target.MUM_TABLE=src.MUM_TABLE,
                                target.MUM_FUNCTION=src.MUM_FUNCTION,
                                target.MUM_JSPFIELD=src.MUM_JSPFIELD,
                                target.MUM_TABLECOLUMN=src.MUM_TABLECOLUMN,
                                target.MUM_LASTSAVED=src.MUM_LASTSAVED,
...
`
  merge into  "DATAHUB_TARGET_HISTORY"."EAM_DELETED_R5MAILURLMAPPING" as target using (
