//  Name:       sp_dw_ips_stage_consump_stg1d
//
//  Purpose:    Load consumption data - staging table dw_ips_stage_consump_stg1d for job sp_dw_ips_stage_consump_stg1d
//
//  Description:
//
...
create or replace procedure datahub_staging.sp_dw_ips_stage_consump_stg1d()
    returns string
    language javascript
    execute as caller
    as
...
//  Truncate target table 
        ...
        snowflake.execute ({sqlText: "TRUNCATE TABLE DATAHUB_STAGING.DW_IPS_STAGE_CONSUMP_STG1d;"});
...
//  Run insert statement
        ...
        try
            ...
            var sqlStmt = snowflake.createStatement( {sqlText: `INSERT INTO DATAHUB_STAGING.DW_IPS_STAGE_CONSUMP_STG1d
		 (SEQ, COMPKEY, READINGKEY, READING, MAXREAD, CONSUMP)
		 SELECT  t1.SEQ, t1.COMPKEY, t1.READINGKEY, t1.READING, t1.MAXREAD, 0 AS CONSUMP
