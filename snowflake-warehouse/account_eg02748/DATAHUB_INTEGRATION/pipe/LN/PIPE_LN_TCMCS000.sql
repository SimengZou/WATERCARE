create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCMCS000 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCMCS000
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCMCS000(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));