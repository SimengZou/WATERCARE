create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TDSMI113 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TDSMI113
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TDSMI113(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));