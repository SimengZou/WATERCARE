create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPCTM060 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPCTM060
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPCTM060(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));