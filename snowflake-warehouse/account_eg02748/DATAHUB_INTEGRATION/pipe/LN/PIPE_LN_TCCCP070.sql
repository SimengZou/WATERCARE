create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCCCP070 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCCCP070
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCCCP070(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));