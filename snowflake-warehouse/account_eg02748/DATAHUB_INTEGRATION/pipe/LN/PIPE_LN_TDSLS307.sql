create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TDSLS307 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TDSLS307
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TDSLS307(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));