create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPSS020 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPSS020
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPSS020(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));