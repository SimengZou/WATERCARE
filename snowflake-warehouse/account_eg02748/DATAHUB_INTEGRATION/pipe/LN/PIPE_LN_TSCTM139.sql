create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TSCTM139 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TSCTM139
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TSCTM139(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));