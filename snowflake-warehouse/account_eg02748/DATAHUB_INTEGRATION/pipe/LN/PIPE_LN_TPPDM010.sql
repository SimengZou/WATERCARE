create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPDM010 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPDM010
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPDM010(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));