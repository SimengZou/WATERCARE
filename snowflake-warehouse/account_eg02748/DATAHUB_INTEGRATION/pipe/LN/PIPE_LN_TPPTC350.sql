create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPTC350 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPTC350
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPTC350(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));