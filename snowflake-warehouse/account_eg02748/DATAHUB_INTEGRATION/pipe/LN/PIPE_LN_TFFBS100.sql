create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFFBS100 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFFBS100
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFFBS100(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));