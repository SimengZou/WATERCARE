create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TDPUR200 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TDPUR200
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TDPUR200(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));