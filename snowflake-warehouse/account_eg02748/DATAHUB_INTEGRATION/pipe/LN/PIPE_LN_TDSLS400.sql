create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TDSLS400 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TDSLS400
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TDSLS400(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));