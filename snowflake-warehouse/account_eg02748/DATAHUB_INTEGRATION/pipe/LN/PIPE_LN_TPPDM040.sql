create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPDM040 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPDM040
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPDM040(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));