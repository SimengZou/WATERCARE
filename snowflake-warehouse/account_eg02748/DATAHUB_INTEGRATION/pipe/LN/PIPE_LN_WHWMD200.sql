create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_WHWMD200 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_WHWMD200
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_WHWMD200(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));