create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPDM085 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPDM085
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPDM085(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));