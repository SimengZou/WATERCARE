create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TDSLS301 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TDSLS301
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TDSLS301(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));