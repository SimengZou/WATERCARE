create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFACP251 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFACP251
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFACP251(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));