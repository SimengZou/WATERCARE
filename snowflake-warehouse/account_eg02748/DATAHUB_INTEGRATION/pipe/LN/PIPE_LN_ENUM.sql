create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_ENUM auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_ENUM
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_ENUM(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));