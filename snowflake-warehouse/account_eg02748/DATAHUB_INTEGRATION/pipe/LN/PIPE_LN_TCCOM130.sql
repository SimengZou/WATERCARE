create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCCOM130 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCCOM130
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCCOM130(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));