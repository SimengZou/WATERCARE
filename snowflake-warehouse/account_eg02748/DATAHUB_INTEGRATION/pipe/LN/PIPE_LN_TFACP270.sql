create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFACP270 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFACP270
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFACP270(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));