create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TIPCF500 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TIPCF500
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TIPCF500(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));