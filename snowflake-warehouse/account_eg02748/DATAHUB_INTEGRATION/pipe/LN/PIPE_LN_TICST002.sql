create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TICST002 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TICST002
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TICST002(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));