create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCMCS028 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCMCS028
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCMCS028(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));