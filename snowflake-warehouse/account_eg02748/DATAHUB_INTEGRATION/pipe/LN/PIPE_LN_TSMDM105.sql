create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TSMDM105 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TSMDM105
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TSMDM105(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));