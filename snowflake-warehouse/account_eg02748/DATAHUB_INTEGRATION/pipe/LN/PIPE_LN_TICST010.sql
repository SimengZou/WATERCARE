create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TICST010 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TICST010
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TICST010(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));