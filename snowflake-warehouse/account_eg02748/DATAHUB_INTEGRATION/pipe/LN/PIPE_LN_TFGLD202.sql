create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFGLD202 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFGLD202
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFGLD202(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));