create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TIPCS020 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TIPCS020
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TIPCS020(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));