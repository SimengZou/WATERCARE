create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TXPDM908 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TXPDM908
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TXPDM908(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));