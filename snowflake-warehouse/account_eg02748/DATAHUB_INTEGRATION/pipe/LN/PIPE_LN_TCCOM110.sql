create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TCCOM110 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TCCOM110
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TCCOM110(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));