create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPDM790 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPDM790
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPDM790(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));