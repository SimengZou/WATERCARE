create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFGLD172 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFGLD172
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFGLD172(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));