create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TPPTC250 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TPPTC250
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TPPTC250(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));