create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TXPDM901 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TXPDM901
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TXPDM901(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));