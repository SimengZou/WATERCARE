create or replace pipe DATAHUB_INTEGRATION.PIPE_LN_TFACP260 auto_ingest=true
            ...
            copy into DATAHUB_LANDING.LN_TFACP260
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_LN_TFACP260(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));