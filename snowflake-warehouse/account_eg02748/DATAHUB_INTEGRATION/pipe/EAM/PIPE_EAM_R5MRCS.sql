create or replace pipe DATAHUB_INTEGRATION.PIPE_EAM_R5MRCS auto_ingest=true
            ...
            copy into DATAHUB_LANDING.EAM_R5MRCS
             from (
                ...
                FROM @DATAHUB_INTEGRATION.STAGE_EAM_R5MRCS(FILE_FORMAT => DATAHUB_INTEGRATION.json_format));