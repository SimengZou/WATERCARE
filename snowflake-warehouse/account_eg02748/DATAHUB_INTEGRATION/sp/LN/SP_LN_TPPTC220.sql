create or replace procedure DATAHUB_INTEGRATION.SP_LN_TPPTC220()
...
try
    {
        var sql_command = `
                            ...
                            SELECT * FROM LANDING_ERROR.VW_STREAM_LN_TPPTC220_ERROR`;
    var sqlStmt = snowflake.createStatement( {sqlText:  sql_command} );
    var rs = sqlStmt.execute();
        
        var sql_command = ` 
                            merge into  TARGET_LN.LN_TPPTC220 as target using (SELECT * FROM (SELECT 
            strm.acln, 
            strm.amoc, 
            strm.amos, 
            strm.btdt, 
        ...
        FROM DATAHUB_INTEGRATION.VW_STREAM_LN_TPPTC220 as  strm
                    )   
            WHERE ROWNUMBER=1  
    ...
    snowflake.execute( {sqlText: `merge into TARGET_HISTORY_LN.LN_TPPTC220_DELETED as target using (
                SELECT * FROM (SELECT 
            strm.acln, 
            strm.amoc, 
            strm.amos, 
        ...
        when not matched   then insert ( acln, amoc, amos, btdt, cact, ccal, ccco, ccco_ref_compnr, clas, clas_ref_compnr, cnln, cocu, cocu_ref_compnr, compnr, cona, cono, cono_ref_compnr, copy, copy_kw, cpla, cprj, cprj_cpla_cact_ref_compnr, cprj_cpla_ref_compnr, cprj_cstl_ref_compnr, cprj_ref_compnr, cpva, cspa, cstl, cuni, cuni_ref_compnr, dbgf, dbgf_kw, deleted, dfpc, dfpc_kw, dlvr, dura, effn, effn_ref_compnr, espp, item, item_ref_compnr, lcta, leng, lino, noun, orno, otbp, otbp_ref_compnr, pric, pris, quan, rfin, rsta, rtcc_1, rtcc_2, rtcc_3, rtcs_1, rtcs_2, rtcs_3, rtfc_1, rtfc_2, rtfc_3, rtfs_1, rtfs_2, rtfs_3, sacu, sacu_ref_compnr, schd, scpf, sequencenumber, sern, slnk, slnk_kw, snsb, stat, stat_kw, timestamp, tmud, trts, trts_kw, tsrl, tsrl_kw, txta, txta_ref_compnr, username, widt, 
                    ETL_SEQUENCE_NUMBER,                       
                    etl_load_datetime,
                    etl_load_metadatafilename,
                    etl_is_deleted,
