create or replace procedure DATAHUB_INTEGRATION.SP_LN_TPPPC296()
...
try
    {
        var sql_command = `
                            ...
                            SELECT * FROM LANDING_ERROR.VW_STREAM_LN_TPPPC296_ERROR`;
    var sqlStmt = snowflake.createStatement( {sqlText:  sql_command} );
    var rs = sqlStmt.execute();
        
        var sql_command = ` 
                            merge into  TARGET_LN.LN_TPPPC296 as target using (SELECT * FROM (SELECT 
            strm.amoc, 
            strm.amoc_cntc, 
            strm.amoc_dwhc, 
            strm.amoc_homc, 
        ...
        FROM DATAHUB_INTEGRATION.VW_STREAM_LN_TPPPC296 as  strm
                    )   
            WHERE ROWNUMBER=1  
    ...
    snowflake.execute( {sqlText: `merge into TARGET_HISTORY_LN.LN_TPPPC296_DELETED as target using (
                SELECT * FROM (SELECT 
            strm.amoc, 
            strm.amoc_cntc, 
            strm.amoc_dwhc, 
        ...
        when not matched   then insert ( amoc, amoc_cntc, amoc_dwhc, amoc_homc, amoc_prjc, amoc_refc, amoc_rpc1, amoc_rpc2, appr, appr_kw, cact, ccco, ccco_ref_compnr, ccur, ccur_ref_compnr, cico, cico_rcmp, compnr, cpla, cprj, cprj_cico, cprj_cpla_cact_ref_compnr, cprj_cspa_ref_compnr, cprj_fcmp, cprj_ref_compnr, cspa, cuni, cuni_ref_compnr, deleted, feac_cntc, feac_dwhc, feac_homc, feac_prjc, feac_refc, feac_rpc1, feac_rpc2, feac_trnc, frat, frat_kw, pric, pric_cntc, pric_dwhc, pric_homc, pric_prjc, pric_refc, pric_rpc1, pric_rpc2, quan, quan_buar, quan_buln, quan_bupc, quan_buvl, quan_buwg, rdat, rgdt, rtcc_1, rtcc_2, rtcc_3, rtfc_1, rtfc_2, rtfc_3, sequencenumber, timestamp, txta, txta_ref_compnr, username, 
                    ETL_SEQUENCE_NUMBER,                       
                    etl_load_datetime,
                    etl_load_metadatafilename,
                    etl_is_deleted,
