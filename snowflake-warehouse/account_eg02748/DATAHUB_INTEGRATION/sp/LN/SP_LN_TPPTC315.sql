create or replace procedure DATAHUB_INTEGRATION.SP_LN_TPPTC315()
...
try
    {
        var sql_command = `
                            ...
                            SELECT * FROM LANDING_ERROR.VW_STREAM_LN_TPPTC315_ERROR`;
    var sqlStmt = snowflake.createStatement( {sqlText:  sql_command} );
    var rs = sqlStmt.execute();
        
        var sql_command = ` 
                            merge into  TARGET_LN.LN_TPPTC315 as target using (SELECT * FROM (SELECT 
            strm.aeqc_1, 
            strm.aeqc_2, 
            strm.aeqc_3, 
            strm.aeqc_4, 
        ...
        FROM DATAHUB_INTEGRATION.VW_STREAM_LN_TPPTC315 as  strm
                    )   
            WHERE ROWNUMBER=1  
    ...
    snowflake.execute( {sqlText: `merge into TARGET_HISTORY_LN.LN_TPPTC315_DELETED as target using (
                SELECT * FROM (SELECT 
            strm.aeqc_1, 
            strm.aeqc_2, 
            strm.aeqc_3, 
        ...
        when not matched   then insert ( aeqc_1, aeqc_2, aeqc_3, aeqc_4, aicc_1, aicc_2, aicc_3, aicc_4, aicl_1, aicl_2, aicl_3, aicl_4, amac_1, amac_2, amac_3, amac_4, asbc_1, asbc_2, asbc_3, asbc_4, atac_1, atac_2, atac_3, atac_4, cact, ccal, compnr, cpla, cprj, cprj_ccal_ref_compnr, cprj_cpla_cact_ref_compnr, cprj_cpla_ref_compnr, cprj_ref_compnr, deleted, qtah, sequencenumber, timestamp, username, 
                    ETL_SEQUENCE_NUMBER,                       
                    etl_load_datetime,
                    etl_load_metadatafilename,
                    etl_is_deleted,
