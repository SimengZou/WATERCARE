create or replace procedure DATAHUB_INTEGRATION.SP_LN_TPPSS200()
...
try
    {
        var sql_command = `
                            ...
                            SELECT * FROM LANDING_ERROR.VW_STREAM_LN_TPPSS200_ERROR`;
    var sqlStmt = snowflake.createStatement( {sqlText:  sql_command} );
    var rs = sqlStmt.execute();
        
        var sql_command = ` 
                            merge into  TARGET_LN.LN_TPPSS200 as target using (SELECT * FROM (SELECT 
            strm.acmn, 
        ...
        FROM DATAHUB_INTEGRATION.VW_STREAM_LN_TPPSS200 as  strm
                    )   
            WHERE ROWNUMBER=1  
            ...
            ((target.cact=src.cact) OR (target.cact IS NULL AND src.cact IS NULL)) 
                ...
                when matched then update set
                    ...
                    target.cdf_depm=src.cdf_depm, 
                    target.cdf_depm_kw=src.cdf_depm_kw, 
                    ...
                    target.coel_rcmp=src.coel_rcmp, 
    ...
    snowflake.execute( {sqlText: `merge into TARGET_HISTORY_LN.LN_TPPSS200_DELETED as target using (
                SELECT * FROM (SELECT 
            strm.acmn, 
            strm.acmn_ref_compnr, 
            strm.actp, 
        ...
        when not matched   then insert ( acmn, acmn_ref_compnr, actp, addr, addr_ref_compnr, aext, afdt, afrt, afrt_kw, anbr, asdt, avtp, avtp_ref_compnr, blbl, blbl_kw, cact, capa, capa_kw, capt, capt_kw, ccal, ccat, ccat_ref_compnr, cctr, cctr_kw, cdf_awip, cdf_camt, cdf_depm, cdf_depm_kw, cdf_uamt, cloc, cnsd, cnst, cnst_kw, coel, coel_rcmp, compnr, cpla, cprj, cprj_cloc_ref_compnr, cprj_cpla_lact_ref_compnr, cprj_cpla_pact_ref_compnr, cprj_cpla_ref_compnr, cprj_cstl_ref_compnr, cprj_ref_compnr, creg, creg_ref_compnr, csec, csec_ref_compnr, cspt, cspt_kw, cstg, cstg_ref_compnr, cstl, cstv, cuni, cuni_ref_compnr, cuti, cuti_ref_compnr, cuvc, cuvc_ref_compnr, ddln, deleted, desc, dfac, dfac_ref_compnr, dura, dwar, dwar_ref_compnr, efdt, eoid, eoty, eoty_kw, esdt, ffhr, fref, freq, glat, glon, gris, hbyn, hbyn_kw, lact, levl, lfdt, litm, litm_ref_compnr, llnr, lsdt, lvps, lvps_kw, mamt, mevl, mevl_kw, ohdt, pact, pcom, plmc, plmp, prin, prin_kw, pris, prms, prnd, prsp, prss, prst, pwar, pwar_ref_compnr, qans, quan, qutm, rcod, rcod_ref_compnr, rdas, rdse, rent, rent_kw, rfac, rfsa_1, rfsa_2, rfsa_3, rfse_1, rfse_2, rfse_3, rout, rtsa_1, rtsa_2, rtsa_3, rtse_1, rtse_2, rtse_3, sacu, sacu_ref_compnr, scmd, scmd_kw, sdch, sdch_kw, seak, secu, secu_ref_compnr, sequencenumber, setl, setl_kw, sfdt, ssdt, stat, stat_kw, tact, tact_kw, tfhr, timestamp, tmud, tmud_ref_compnr, totf, txta, txta_ref_compnr, username, wast, wast_kw, 
                    ETL_SEQUENCE_NUMBER,                       
                    etl_load_datetime,
                    etl_load_metadatafilename,
                    etl_is_deleted,
