create or replace procedure DATAHUB_INTEGRATION.SP_LN_TPPTC130()
...
try
    {
        var sql_command = `
                            ...
                            SELECT * FROM LANDING_ERROR.VW_STREAM_LN_TPPTC130_ERROR`;
    var sqlStmt = snowflake.createStatement( {sqlText:  sql_command} );
    var rs = sqlStmt.execute();
        
        var sql_command = ` 
                            merge into  TARGET_LN.LN_TPPTC130 as target using (SELECT * FROM (SELECT 
            strm.acln, 
            strm.amoc, 
            strm.amos, 
            strm.btdt, 
            ...
            strm.cprj_cspa_sero_ref_compnr, 
        ...
        FROM DATAHUB_INTEGRATION.VW_STREAM_LN_TPPTC130 as  strm
                    )   
            WHERE ROWNUMBER=1  
            ...
            ((target.sern=src.sern) OR (target.sern IS NULL AND src.sern IS NULL)) 
                ...
                when matched then update set
                    ...
                    target.cprj_cspa_sero_ref_compnr=src.cprj_cspa_sero_ref_compnr, 
    ...
    snowflake.execute( {sqlText: `merge into TARGET_HISTORY_LN.LN_TPPTC130_DELETED as target using (
                SELECT * FROM (SELECT 
            strm.acln, 
            strm.amoc, 
            strm.amos, 
        ...
        when not matched   then insert ( acln, amoc, amos, btdt, cact, ccco, ccco_ref_compnr, cocu, cocu_ref_compnr, compnr, cona, cpla, cprj, cprj_cpla_cact_ref_compnr, cprj_cpla_ref_compnr, cprj_cspa_ref_compnr, cprj_cspa_sero_ref_compnr, cprj_cstl_ref_compnr, cprj_ref_compnr, cspa, cstl, cuni, cuni_ref_compnr, deleted, dfrc, dfrc_kw, eqan, freq, norm, orno, quan, ratc, rats, rfac, rtcc_1, rtcc_2, rtcc_3, rtcs_1, rtcs_2, rtcs_3, rtfc_1, rtfc_2, rtfc_3, rtfs_1, rtfs_2, rtfs_3, sacu, sacu_ref_compnr, sequencenumber, sern, sero, stat, stat_kw, task, timestamp, trts, trts_kw, tsrl, tsrl_kw, txta, txta_ref_compnr, unrt, unrt_ref_compnr, username, 
                    ETL_SEQUENCE_NUMBER,                       
                    etl_load_datetime,
                    etl_load_metadatafilename,
                    etl_is_deleted,
